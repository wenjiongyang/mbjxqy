...
Fuben:SetFubenSetting(25, tbFubenSetting)
tbFubenSetting.szFubenClass = "PersonalFubenBase"
tbFubenSetting.szName = "测试副本"
tbFubenSetting.szNpcPointFile = "Setting/Fuben/PersonalFuben/2_2/NpcPos.tab"
tbFubenSetting.szPathFile = "Setting/Fuben/PersonalFuben/2_2/NpcPath.tab"
