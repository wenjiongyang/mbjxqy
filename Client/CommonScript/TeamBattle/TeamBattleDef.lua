...
TeamBattle.nMonthlyOpenWeek = 1
TeamBattle.nMonthlyOpenWeekDay = 3
TeamBattle.nMonthlyOpenHour = 21
TeamBattle.nMonthlyOpenMin = 0
TeamBattle.nQuarterlyOpenMonth = 3
TeamBattle.nQuarterlyOpenWeek = -1
TeamBattle.nQuarterlyOpenWeekDay = 3
TeamBattle.nQuarterlyOpenHour = 21
TeamBattle.nQuarterlyOpenMin = 0
TeamBattle.nYearOpenMonth = 1
TeamBattle.nYearOpenWeek = -1
TeamBattle.nYearOpenWeekDay = 3
TeamBattle.nYearOpenHour = 21
TeamBattle.nYearOpenMin = 0
TeamBattle.nMonthlyAddTitle = 7700
TeamBattle.nQuarterlyAddTitle = 7701
TeamBattle.nFloor2Num = 32
TeamBattle.PRE_MAP_ID = 1040
TeamBattle.TOP_MAP_ID = 1047
TeamBattle.TOP_MAP_ID_CROSS = 1057
TeamBattle.tbTopPoint = {
  {1794, 4044},
  {1804, 2505}
}
TeamBattle.nAddImitity = 20
TeamBattle.nTopMapTime = 1200
TeamBattle.nPreMapTime = 300
TeamBattle.nMinLevel = 30
TeamBattle.nMinTeamCount = 16
TeamBattle.nFightTime = 220
TeamBattle.nTeamMemeber = 3
TeamBattle.nMaxFightTimes = 5
TeamBattle.nMaxFloor = 7
TeamBattle.nMaxFloor_Cross = 8
TeamBattle.nTryStartCount = 3
TeamBattle.nDeathSkillState = 1520
TeamBattle.nMaxTimes = 3
TeamBattle.tbRefreshDay = {
  3,
  6,
  7
}
...
TeamBattle.tbStartFailMailInfo = {
  [TeamBattle.TYPE_MONTHLY] = {
    "月度通天塔开启失败",
    "      很遗憾，由于本场月度通天塔竞技比赛晋级玩家不足，导致不能正常举行比赛。现已为您准备了月度通天塔的最高奖励作为补偿，请查收。\n      望少侠再度征战通天塔，下一次能遇到旗鼓相当的对手，勇夺殊荣！"
  },
  [TeamBattle.TYPE_QUARTERLY] = {
    "季度通天塔开启失败",
    "      很遗憾，由于本场季度通天塔竞技比赛晋级玩家不足，导致不能正常举行比赛。现已为您准备了季度通天塔的最高奖励作为补偿，请查收。\n      望少侠再度征战通天塔，下一次能遇到旗鼓相当的对手，勇夺殊荣！"
  },
  [TeamBattle.TYPE_YEAR] = {
    "年度通天塔开启失败",
    "      很遗憾，由于本场年度通天塔竞技比赛晋级玩家不足，导致不能正常举行比赛。现已为您准备了年度通天塔的最高奖励作为补偿，请查收。\n      望少侠再度征战通天塔，下一次能遇到旗鼓相当的对手，勇夺殊荣！"
  }
}
TeamBattle.tbSpaceTipsMailInfo = {
  [TeamBattle.TYPE_MONTHLY] = {
    "月度通天塔参与失败",
    "      很遗憾，由于您在月度通天塔竞技比赛中，未能组满队伍，导致不能正常参与比赛。现已为您准备了月度通天塔的基础奖励，请查收。\n      望少侠下次准备充分，携手队友，再度征战通天塔！"
  },
  [TeamBattle.TYPE_QUARTERLY] = {
    "季度通天塔参与失败",
    "      很遗憾，由于您在季度通天塔竞技比赛中，未能组满队伍，导致不能正常参与比赛。现已为您准备了季度通天塔的基础奖励，请查收。\n      望少侠下次准备充分，携手队友，再度征战通天塔！"
  },
  [TeamBattle.TYPE_YEAR] = {
    "年度通天塔参与失败",
    "      很遗憾，由于您在年度通天塔竞技比赛中，未能组满队伍，导致不能正常参与比赛。现已为您准备了年度通天塔的基础奖励，请查收。\n      望少侠下次准备充分，携手队友，再度征战通天塔！"
  }
}
TeamBattle.tbAwardMailInfo = {
  [TeamBattle.TYPE_MONTHLY] = {
    "月度通天塔挑战奖励",
    "      恭喜你在本次月度通天塔中登上%s层，获得如下奖励。"
  },
  [TeamBattle.TYPE_QUARTERLY] = {
    "季度通天塔挑战奖励",
    "      恭喜你在本次季度通天塔中登上%s层，获得如下奖励。"
  },
  [TeamBattle.TYPE_YEAR] = {
    "年度通天塔挑战奖励",
    "      恭喜你在本次年度通天塔中登上%s层，获得如下奖励。"
  }
}
TeamBattle.nPreTipTime = 172800
TeamBattle.tbLeagueTipMailInfo = {
  [TeamBattle.TYPE_MONTHLY] = {
    "月度通天塔参赛通知",
    "      您已获得本次月度通天塔竞技的参赛资格，比赛时间为[EACC00]%s[-]，请您务必准时参加。届时会有更丰厚的奖励以及更高的荣誉等着您！"
  },
  [TeamBattle.TYPE_QUARTERLY] = {
    "季度通天塔参赛通知",
    "      您已获得本次季度通天塔竞技的参赛资格，比赛时间为[EACC00]%s[-]，请您务必准时参加。届时会有更丰厚的奖励以及更高的荣誉等着您！"
  },
  [TeamBattle.TYPE_YEAR] = {
    "年度通天塔参赛通知",
    "      您已获得本次年度通天塔竞技的参赛资格，比赛时间为[EACC00]%s[-]，请您务必准时参加。届时会有更丰厚的奖励以及更高的荣誉等着您！"
  }
}
...
TeamBattle.tbMsg = {
  ...
  [TeamBattle.emMsgTeamMemeberErr] = "组队模式只允许%s人报名！",
...
function TeamBattle:CheckTicket(pPlayer, nType, nTime)
  ...
  if nType == self.TYPE_MONTHLY then
    ...
    if pPlayer.GetUserValue(self.SAVE_GROUP, self.SAVE_MONTHLY_INFO) == nCheckMonth or pPlayer.GetUserValue(self.SAVE_GROUP, self.SAVE_MONTHLY_INFO_OLD) == nCheckMonth then
      return true
    end
  elseif nType == self.TYPE_QUARTERLY then
    local nLocalSeason = Lib:GetLocalSeason(nNextOpenTime)
    if pPlayer.GetUserValue(self.SAVE_GROUP, self.SAVE_QUARTERLY_INFO) == nLocalSeason or pPlayer.GetUserValue(self.SAVE_GROUP, self.SAVE_QUARTERLY_INFO_OLD) == nLocalSeason then
      return true
    end
  elseif nType == self.TYPE_YEAR then
    local nLocalYear = Lib:GetLocalYear(nNextOpenTime)
    nLocalYear = nLocalYear - 1
    if pPlayer.GetUserValue(self.SAVE_GROUP, self.SAVE_YEAR_INFO) == nLocalYear or pPlayer.GetUserValue(self.SAVE_GROUP, self.SAVE_YEAR_INFO_OLD) == nLocalYear then
      return true
    end
  end
  return false
