...
function WhiteTigerFuben:IsMyMap(nMapTemplateId)
  ...
  return nMapTemplateId == self.PREPARE_MAPID or nMapTemplateId == self.FIGHT_MAPID or nMapTemplateId == self.OUTSIDE_MAPID or nMapTemplateId == self.CROSS_MAP_TID
end
