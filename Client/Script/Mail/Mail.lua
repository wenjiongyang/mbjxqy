function Mail:OnUpdateMailCount(nTotalCount, nUnreadMailCount, nSerNewestMailId)
...
function Mail:GetMailData()
  ...
  for i = #tbAllMails, 1, -1 do
    ...
    if tbMail.ReadFlag and not tbMail.tbAttach and not tbMail.bNotAutoDelete then
