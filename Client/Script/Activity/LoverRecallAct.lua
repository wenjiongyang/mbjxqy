...
tbArborDayCure.tbSubInfo1 = {
  {
    szType = "Item2",
    szInfo = "吾爱情缘忆江湖\n     2017年[FFFE0D]5月19日-22日凌晨4点[-]，侠士通过完成[FFFE0D]一个每日目标[-]即可获得一个线索，每[FFFE0D]五个线索[-]可以合成一份[FFFE0D]地图[-]，可选择自己想进行的故事进行，可邀请[FFFE0D]一名亲密度5级及以上的异性好友组成队伍[-]前往。邀请者将获得一份随机奖励，据闻其中有可能得到稀有的[FFFE0D]超帅外装[-]哦！而被邀请者也能获得奖励。每人每天不限制开启次数，但只有一次进入他人线索地图的次数哦！",
    szBtnText = "获取线索",
    szBtnTrap = "[url=openwnd:test, CalendarPanel]"
  }
}
function tbArborDayCure.FuncSubInfo(tbData)
  local tbSubInfo = {}
