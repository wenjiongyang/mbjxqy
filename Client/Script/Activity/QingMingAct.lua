...
function tbQingMingAct.FuncContent(tbData)
...
tbQingMingAct.tbSubInfo1 = {
  {
    szType = "Item2",
    szInfo = "江湖夜雨十年灯\n     2017年[FFFE0D]4月2日-5日凌晨4点[-]，侠士通过完成[FFFE0D]一个每日目标[-]以及[FFFE0D]五次家族捐献[-]均可获得一个线索，通过[FFFE0D]家族捐献[-]每天[FFFE0D]最多获得五个线索[-]，每[FFFE0D]五个线索[-]可以合成一份[FFFE0D]随机地图[-]，可邀请[FFFE0D]一名亲密度5级以上的好友组成队伍[-]前往。双方均可获得经验！邀请者更可获得一份随机奖励！每人每天不限制开启次数，但只有一次进入他人线索地图的次数哦！",
    szBtnText = "获取线索",
    szBtnTrap = "[url=openwnd:test, CalendarPanel]"
  }
}
function tbQingMingAct.FuncSubInfo(tbData)
  local tbSubInfo = {}
