...
tbDaiYanRen.szTitle = "真枫不离伴江湖"
tbDaiYanRen.nBottomAnchor = -50
function tbDaiYanRen.FuncContent(tbData)
...
function tbDaiYanRen.fnCustomCheckRP(tbData)
