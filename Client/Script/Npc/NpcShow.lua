...
function NpcShow:LoadData()
  local tbShowData = LoadTabFile("Setting/Npc/NpcShowInfo.tab", "dsssssdd", "nTemplateId", {
    "nTemplateId",
    "szAction",
    "nDist",
    "szInfo",
...
function NpcShow:LookToNpc(nNpcId, fnCallback)
...
function NpcShow:OnPlayEnd(bWait)
  if bWait then
