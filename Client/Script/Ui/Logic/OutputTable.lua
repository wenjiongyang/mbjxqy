OutputTable.FUBEN = 1
OutputTable.TEAM_FUBEN = 2
OutputTable.RANDOM_FUBEN = 3
OutputTable.TOP_BOSS = 4
OutputTable.WILD_BOSS = 5
OutputTable.GREAT_GEN = 6
OutputTable.SHOP_Treasure = 7
...
function OutputTable:LoadOtherSetting()
  local tbSetting = Lib:LoadTabFile("Setting/OutputTable/PartnerEquipOutput.tab", {
    TemplateID = 0,
    Type = 0,
    ExtPar1 = 0,
    ExtPar2 = 0,
