...
function tbUi:OnOpen(nItemId)
  ...
  self.nPrice, self.szMoneyType = self:GetSellSumPrice(pItem.dwTemplateId)
  local name = pItem.GetItemShowInfo(me.nFaction)
