...
function tbUi:UpdateInfo(nItemID, nItemTID, tbIntValueInfo)
  ...
  if nItemID then
    ...
    self.pPanel:SetActive("SkillRedmark", (bRet or bRet1 or bRet2) and pItem.nPos ~= Item.EITEMPOS_BAG)
  ...
  local szName, nIcon, nView, nQuality = KItem.GetItemShowInfo(nItemTID, me.nFaction)
  ...
  self.pPanel:Label_SetText("SkillDetails", string.format([[
%s
