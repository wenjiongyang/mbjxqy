...
function tbUi:UpdateRigtItemList()
  ...
  self.ScrollViewRight:Update(math.max(math.ceil(#self.tbRightItemList / ITEM_PER_LINE), MIN_LINE), fnSetItem)
end
function tbUi:UpdateLeftItemList()
  ...
  self.ScrollViewLeft:Update(math.max(math.ceil(#self.tbLeftItemList / ITEM_PER_LINE), MIN_LINE), fnSetItem)
end
