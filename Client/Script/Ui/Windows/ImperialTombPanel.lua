...
function tbUi:UpdateSubContent(tbSubInfo)
  ...
  if self.bFemaleEmperor and tbSubInfo.nTemplateId ~= ImperialTomb.EMPEROR_INFO.nTemplate and tbSubInfo.nTemplateId ~= ImperialTomb.FEMALE_EMPEROR_INFO.nTemplate then
  ...
  for nIndex, tbEnterInfo in ipairs(tbSubInfo.tbEnterList) do
    ...
    if nStatus == ImperialTomb.BOSS_STATUS.NONE then
      ...
      if tbEnterInfo.nMapType == ImperialTomb.MAP_TYPE.FEMALE_EMPEROR_BOSS_ROOM then
...
function tbUi:RegisterEvent()
  local tbRegEvent = {
    {
      UiNotify.emNOTIFY_IMPERIAL_TOMB_BOSS_STATUS,
