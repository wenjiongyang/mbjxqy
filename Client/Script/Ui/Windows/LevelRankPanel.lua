...
function tbNewInfoUi:RefreshMainUi()
  ...
  local nRankReaminCount2 = 0 > 10 - nLevelRank - nRankReaminCount1 and 0 or 10 - nLevelRank - nRankReaminCount1
  local nRankRemainCount3 = 0
  if nRankReaminCount2 > 0 then
    nRankRemainCount3 = 90
  else
    nRankRemainCount3 = 0 > 100 - nLevelRank and 0 or 100 - nLevelRank
  end
...
function tbNewInfoUi:RegisterEvent()
  return {
    {
      UiNotify.emNOTIFY_ONSYNC_LEVEL_RANK,
      self.RefreshUi
    }
  }
end
