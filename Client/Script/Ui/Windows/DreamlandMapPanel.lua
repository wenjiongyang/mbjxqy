...
function tbUi:Update()
  local tbRooomPosSetting = InDifferBattle.tbRooomPosSetting
  ...
  local nRow, nCol = unpack(InDifferBattle.tbRoomIndex[nMyRoomIndex])
...
function tbUi:OnClickItem(nRow, nCol)
  local nRoomIndex = InDifferBattle:GetRoomIndexByRowCol(nRow, nCol)
