...
tbUi.tbSetting = {
  ...
  [tbUi.Kin_List] = {
    ...
    fnSetItem = function(itemObj)
      ...
      itemObj.pPanel:Sprite_SetSprite("SpFaction", SpFaction)
      local szPortrait, szAltas = PlayerPortrait:GetSmallIcon(tbMemberData.nPortrait or tbMemberData.nFaction)
      itemObj.pPanel:Sprite_SetSprite("SpRoleHead", szPortrait, szAltas)
  ...
  [tbUi.Apply_List] = {
    szBtnName = "Tab3",
    fnGetList = function()
      return Wedding:GetWeddingMapApply()
    end,
    fnGetNoneTip = function()
      return "暂无人申请"
    end,
...
function tbUi:RegisterEvent()
  return {
    {
      UiNotify.emNOTIFY_SYNC_WEDDING_WELCOME,
      self.SwitchContainer
    },
    {
      UiNotify.emNOTIFY_SYNC_KIN_DATA,
      self.OnSynKinDataFinish
    }
  }
end
tbUi.tbOnClick = {
