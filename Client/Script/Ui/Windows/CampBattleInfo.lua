...
function tbUi:UpdateLeftInfo()
  ...
  if Battle.nBattleRevieTime and nNow < Battle.nBattleRevieTime then
  ...
  elseif szType == "Dmg" then
    ...
    if nMySide == nSide1 or nMySide == nSide2 or Battle.nTeamIndex and 0 < Param1[Battle.nTeamIndex] then
...
function tbUi:ShowTime()
  ...
  if self.tbShowTimeSetting and self.tbShowTimeSetting[self.nState] then
