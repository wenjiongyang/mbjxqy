...
function PrayPanel:StopAnimation()
  ...
  local nTotalAngle = 1440 + nCurAngle - nTarAngle
  local nCount = 10
  for i = 1, nCount do
...
PrayPanel.tbWuxingWordSpriteNormal = {
  "jin1",
  "mu1",
  "shui1",
  "huo1",
...
PrayPanel.tbWuxingWordSpriteLight = {
  "jin2",
  "mu2",
  "shui2",
  "huo2",
