...
tbGrid.tbOnClick = {}
function tbGrid.tbOnClick:CardBack()
...
function tbUi:OnOpen(bSuccess, nItemId, nIndex)
  ...
  self.pPanel:SetActive("txt", true)
  ...
  if bSuccess and nItemId and nIndex then
    ...
    self.Itemframe:SetItemByTemplate(nItemId, nil, nil, nil, nIndex)
    ...
    if bSuccess then
      ...
      self.pPanel:SetActive("PowerUp", true)
...
function tbUi:OnClose()
  if self.nSel then
    ...
    tbCard.pPanel:PlayUiAnimation("TurnoverCardReset", false, false, {
      tostring(tbCard.pPanel)
    })
  end
...
function tbUi:UpdateSeldAward(tbAward)
  ...
  tbCard.pPanel:PlayUiAnimation("TurnoverCard", false, false, {
    tostring(tbCard.pPanel)
  })
end
