...
function tbUi:Refresh(tbData)
  if not (tbData and tbData.nCurWatchId and tbData.szType and tbBattleType[tbData.szType] and tbData.tbPlayer) or #tbData.tbPlayer == 0 then
    return
  end
...
function tbUi:RegisterEvent()
  local tbRegEvent = {
    {
      UiNotify.emNOTIFY_REFRESH_WATCH,
      self.Refresh,
      self
    },
    {
