...
function tbUi:RemoveOneMsg()
  ...
  self.pPanel:Tween_RunWhithStartPos("Notice" .. nRemoveNoticeIdx, 0, -100, 0, -120, 0.01)
...
function tbUi:UpdateCenterMsg()
  ...
  for _, szMsg in ipairs(tbMsg) do
    if 0 < #self.tbCacheMsg or #self.tbAllMsg >= self.nMaxMsgCount then
