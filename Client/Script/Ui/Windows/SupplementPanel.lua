...
function tbUi:Update()
  ...
  if nItemNum > 0 then
    local szName = KItem.GetItemShowInfo(SupplementAward.ITEM_TYPE_TID, me.nFaction)
  ...
  local function fnSetItem(tbItem, nIdx)
...
function tbItem:Update(tbInfo, bCoin)
  ...
  local bDiscount = 1 > SupplementAward:GetDiscount()
