...
function tbUi:Update()
  for i = 1, 3 do
    ...
    if not tbPlayerData then
      ...
      local szHead, szAtlas = PlayerPortrait:GetSmallIcon(tbPlayerData.nPortrait or tbPlayerData.nFaction)
      ...
      self.pPanel:SetActive("FriendTxt" .. i, me.dwID ~= tbPlayerData.nPlayerId)
      self.pPanel:SetActive("BtnReceive" .. i, me.dwID ~= tbPlayerData.nPlayerId and not FriendShip:IsFriend(me.dwID, tbPlayerData.nPlayerId))
...
function tbUi:OnMakeFriend(nIdx)
  ...
  FriendShip:RequetAddFriend(tbPlayerData.nPlayerId)
