...
function tbUi:UpDateChampionUi()
  ...
  if self.nWinTeamId then
    ...
    self.pPanel:ChangePosition("Guessing", 2, -217)
  ...
  elseif self.bHasFinal then
    self.pPanel:ChangePosition("Guessing", 2, -149)
...
function tbUi:SetChampionPlayerInfo(nIndex, tbShowInfo)
  ...
  if tbShowInfo.nHonorLevel > 0 then
    ...
    self.pPanel:Sprite_Animation("ChaPlayerTitle" .. nIndex, "Title" .. tbShowInfo.nHonorLevel .. "_")
  else
