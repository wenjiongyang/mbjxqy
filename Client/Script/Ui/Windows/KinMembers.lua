...
function tbUi:SortList(tbMemberList)
  ...
  table.sort(tbMemberList, function(a, b)
    ...
    elseif b.nMemberId == me.dwID then
      return false
    elseif a.tbCommerceHelp and b.tbCommerceHelp or not a.tbCommerceHelp and not b.tbCommerceHelp then
...
function tbUi:UpdateMemberListInfo(szSortFun, bIsDown)
  ...
  local fnShowCommerceHelp = function(buttonObj)
    local tbCommerceHelp = buttonObj.root.tbMemberData.tbCommerceHelp
    local szName = buttonObj.root.tbMemberData.szName
  ...
  local function fnSetItem(itemObj, nIndex)
    ...
    itemObj.pPanel:Button_SetSprite("Main", itemObj.bSelf and "BtnListThirdOwn" or "ListBarNormal", 1)
    ...
    itemObj.pPanel:SetActive("PlayerTitle", 0 < tbMemberData.nHonorLevel)
    itemObj.pPanel:Sprite_Animation("PlayerTitle", "Title" .. tbMemberData.nHonorLevel .. "_")
    ...
    local fnChuangGong = function(buttonObj)
    ...
    itemObj.pPanel:SetActive("Box", tbMemberData.tbCommerceHelp and true or false)
