...
function tbUi:Init()
  ...
  self.pPanel:SetActive("Group1", tbPartnerPos[1] > 0 or 0 < tbPartnerPos[2])
  self.pPanel:SetActive("Group2", 0 < tbPartnerPos[3] or tbPartnerPos[4] > 0)
  self:ShowGroup(-1)
end
...
function tbUi.tbOnClick:Group1()
  self:ShowGroup(1)
end
function tbUi.tbOnClick:Group2()
  self:ShowGroup(2)
end
