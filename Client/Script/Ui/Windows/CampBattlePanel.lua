    ...
    for i = 1, 6 do
      ...
      if tbInfo then
        ...
        if tbHonorInfo then
          ...
          self.pPanel:Sprite_Animation(szUiHonor, tbHonorInfo.ImgPrefix)
        else
        ...
        local tbPortaitSetting = PlayerPortrait:GetPortraitSetting(tbInfo.nPortrait)
        self.pPanel:Sprite_SetSprite(string.format("%sHead%d", szUiPrefix, i - 1), tbPortaitSetting.szBigIcon, tbPortaitSetting.szBigIconAtlas)
