...
tbUi.tbOnClick = {
  BtnInteraction = function(self)
    ...
    elseif 0 >= me.GetUserValue(self.GROUP, self.TITLE_FLAG) then
  ...
  local function fnSet(itemObj, nIdx)
    ...
    for i = 1, 2 do
      ...
      if nTitleId then
        ...
        if tbInfo.GTopColorID > 0 and 0 < tbInfo.GBottomColorID then
        ...
        if 0 < tbInfo.OutlineColorID then
