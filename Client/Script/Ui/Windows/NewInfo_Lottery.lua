...
tbNotifyUI.szContent = "赠礼资格获得途径：使用[C8FF00][url=openwnd:盟主的馈赠, ItemTips, \"Item\", nil, 6144][-]（[FFD300][url=openwnd:获得途径, AttributeDescription, '', false, 'Lottery'][-]），本周已使用[C8FF00]%d[-]张。\n赠礼资格刷新时间：每周日晚19:30，发奖前使用[C8FF00][url=openwnd:盟主的馈赠, ItemTips, \"Item\", nil, 6144][-]的数量越多，被盟主青睐的机会越大\n"
...
tbResultUI.szContent = "武林盟主已经选好了本周他所青睐的少侠，恭喜诸位幸运儿。\n"
...
function tbResultUI:RefreshUi()
  ...
  local function fnSetLuckyGuy(tbLuckyBuy, nIndex)
