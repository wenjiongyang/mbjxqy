...
function tbUi:RegisterEvent()
  local tbRegEvent = {
    {
      UiNotify.emNOTIFY_SYNC_BATTLEARRAY,
      self.OnSyncBattleArray
    }
  }
  return tbRegEvent
end
...
function tbUi.tbOnClick:BtnFight()
  if self.fnCallback and self.fnCallback(unpack(self.tbArg)) == 0 then
    return
  end
  Ui:CloseWindow(self.UI_NAME)
end
