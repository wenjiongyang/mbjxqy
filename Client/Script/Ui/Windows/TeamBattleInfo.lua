...
function tbUi:RegisterEvent()
  local tbRegEvent = {
    {
      UiNotify.emNOTIFY_TEAM_BATTLE_KILL_INFO,
      self.OnChangeFightInfo,
      self
    },
    {
      UiNotify.emNOTIFY_TEAM_BATTLE_TIME,
      self.OnChangeTime,
      self
    },
    {
      UiNotify.emNOTIFY_TEAM_BATTLE_HIDE_SCORE,
      self.HideStarTowerScore,
      self
    }
  }
  return tbRegEvent
