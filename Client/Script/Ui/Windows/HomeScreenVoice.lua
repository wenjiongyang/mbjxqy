...
function tbUi:RegisterEvent()
  local tbRegEvent = {
    {
      UiNotify.emNOTIFY_CHAT_ROOM_STATUS,
      self.OnChatRoomStatusChange,
      self
    },
    {
      UiNotify.emNOTIFY_ON_HOME_TASK_FOLD,
      self.OnFold,
      self
    }
  }
...
tbUi.tbOnClick = {}
function tbUi.tbOnClick:BtnEarphone()
...
function tbUi.tbOnClick:BtnMicrophone()
  local isMicAvailable, isTmpDisable = ChatMgr:IsCanUseRoomMic()
