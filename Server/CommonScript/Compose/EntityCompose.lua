...
function EntityCompose:LoadSetting()
	...
	local tbParams = {"TargetTemplateID", "IsShowFrag","IsHideTip", "ConsumeType","ConsumeCount", "BagSort"};
...
function EntityCompose:CheckIsCanCompose(pPlayer,nTemplateId)
	...
	local szTip = string.format("您的材料不足，無法合成【%s】",KItem.GetItemShowInfo(nTargetID, pPlayer.nFaction));
