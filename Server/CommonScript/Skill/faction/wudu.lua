...
local tb    = {
	...
	--		},
		dotdamage_wood={{{1,4},{20,10},{30,12},{32,13}},{{1,5},{20,30},{30,150},{32,160}},15*0.5},  	--毒伤：发挥基础攻击力，毒攻点数，伤害间隔
		skill_statetime={{{1,15*6},{15,15*6},{16,15*6}}},							--毒的持续时间
		skill_dot_ext_type={1},															--增加受到的毒伤%的标记，有dotdamage_wood的技能都要加上
		state_npchurt_attack={100,7},
		missile_hitcount={{{1,2},{20,2},{30,2},{32,2}}},
	...
	--		},
		dotdamage_wood={{{1,5},{20,12},{30,14},{32,15}},{{1,5},{20,40},{30,150},{32,160}},15*0.5},  	--毒伤：发挥基础攻击力，毒攻点数，伤害间隔
		skill_statetime={{{1,15*6},{15,15*6},{16,15*6}}},							--毒的持续时间
		skill_dot_ext_type={1},															--增加受到的毒伤%的标记，有dotdamage_wood的技能都要加上
		state_npchurt_attack={100,7},
...
--			},
    ...
    { 
		...
		userdesc_103={{{1,2},{10,20},{11,22},{21,42}}},		--描述用：赤蝎会心一击,wudu_zhdc_cx_skill
    ...
    wudu_zhdc_cx_skill = --赤蝎技能（会心一击）
    { 
		attack_usebasedamage_p={280},
		attack_deadlystrike_p={100},		--此次攻击必定会心
    },
    ...
    { 
		...
		add_dotdshield_p={2,{{1,10},{10,40},{11,45}}},			--毒攻dot对护盾的伤害提高：五行类型，百分比
    ...
    wudu_bdcx = --百毒穿心-40级被动2（光环）--10级
    { 
		deadlystrike_p={{{1,60},{10,120},{11,130}}},		
		userdesc_101={{{1,30},{10,60},{11,65}}},					--描述用：用增加队友基础会心几率
		skill_statetime={{{1,15*3},{10,15*3},{11,15*3}}},
    },	
    wudu_bdcx_team = --百毒穿心_队友--10级
    { 
		deadlystrike_p={{{1,30},{10,60},{11,65}}},
		skill_statetime={{{1,15*3},{10,15*3},{11,15*3}}},
    },	
    ...
    { 
		infect_dot_dmg={{{1,5},{10,30},{11,35}},3,{{1,1},{4,1},{5,2},{9,2},{10,3}}},		--传递的伤害比例，能被传染的类型SkillSetting.ini,数量
