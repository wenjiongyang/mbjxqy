...
nPlayerEnterLevel = 20;   -- 武林盟主参与等级限制
...
nNoKinRewardScore = 40000; -- 没有家族时对应的家族奖励价值量
...
-- 家族排名 拍卖对应分数
KinRwardRankScore = {
	{Rank = 1, Score = 900000};  -- 第一名
	{Rank = 2, Score = 600000};  -- 第二名
	{Rank = 4, Score = 500000};  -- 第三名
	{Rank = 10, Score = 400000};
	{Rank = 20, Score = 250000};
	{Rank = 30, Score = 300000};
	{Rank = 40, Score = 200000};
	{Rank = math.huge, Score = 5000000}; -- 41-无穷  0.6
};
...
tbBossHpStage = {
	...
	{HpRate = 1, ScoreRate = 1, Texture = "BossStage01", RateTexture = "Points01"};
};
...
tbPlayerBoxRankScore = {
	{Rank = 1, Honor = 30000};  -- 第一名
	{Rank = 2, Honor = 26000};  -- 第二名
	{Rank = 10, Honor = 24000};
	{Rank = 20, Honor = 22000};
	{Rank = 50, Honor = 20000};
...
tbKinBoxRankScore = {
	...
	{Rank = 18, Honor = 120};
	{Rank = 24, Honor = 100};
	{Rank = math.huge, Honor = 90}; -- 上面的排名之后到无穷大  0.6
};
...
tbAuctionRewards = {
	...
	};
	{
		...
		Rewards = {
					...
					{nBossId = 1896, nRate = 0.5/5.5, Items = {2253}},		--南宫飞云同伴
					{nBossId = 1897, nRate = 0.5/5.5, Items = {2254}},		--杨影枫同伴
					{nRate = 0.25/5.5, Items = {4308}},						--3级金属
					{nRate = 0.5/5.5, Items = {4309}},						--4级金属						
					{nRate = 0.5/5.5, Items = {2980}},						--T8稀有衣服碎片
					{nRate = 0.5/5.5, Items = {1396}},						--帝皇令					
					{nRate = 0.5/5.5, Items = {3462}},						--赤金驭天绳碎片
	...
	};
	{
		...
		Rewards = {
					...
					{nBossId = 1896, nRate = 0.5/5.5, Items = {2253}},		--南宫飞云同伴
					{nBossId = 1897, nRate = 0.5/5.5, Items = {2254}},		--杨影枫同伴
					{nBossId = 2189, nRate = 0.5/5.5, Items = {2255}},		--唐简同伴
					{nRate = 0.25/5.5, Items = {4308}},						--3级金属
					{nRate = 0.5/5.5, Items = {4309}},						--4级金属											
					{nRate = 0.5/5.5, Items = {2981}},						--T9稀有衣服碎片
					{nRate = 0.75/5.5, Items = {1396}},						--帝皇令	
					{nRate = 0.5/5.5, Items = {3462}},						--赤金驭天绳碎片
					{nRate = 0.25/5.5, Items = {3461}},						--苍虹降龙绳碎片
					{nBossId = 634, nRate = 0.5/5.5, Items = {2668}},		--独孤剑魂石
					{nBossId = 1896, nRate = 0.5/5.5, Items = {2880}},		--南宫飞云魂石
	...
	};
	{
		...
		Rewards = {
					...
					{nBossId = 1897, nRate = 0.5/5.5, Items = {2254}},		--杨影枫同伴
					{nBossId = 2189, nRate = 0.5/5.5, Items = {2255}},		--唐简同伴
					{nRate = 0.2/5.5, Items = {4308}},						--3级金属
					{nRate = 0.55/5.5, Items = {4309}},						--4级金属
					--{nRate = 0.5/5.5, Items = {4310}},					--5级金属							
					{nRate = 0.5/5.5, Items = {3679}},						--T10稀有衣服碎片
					{nRate = 1/5.5, Items = {1396}},						--帝皇令					
					{nRate = 0.25/5.5, Items = {3462}},						--赤金驭天绳碎片
					{nRate = 0.25/5.5, Items = {3461}},						--苍虹降龙绳碎片
					{nBossId = 634, nRate = 0.5/5.5, Items = {2668}},		--独孤剑魂石
					{nBossId = 1896, nRate = 0.5/5.5, Items = {2880}},		--南宫飞云魂石
					{nBossId = 1897, nRate = 0.5/5.5, Items = {2881}},		--杨影枫魂石
	...
	};
	{
		...
		Rewards = {
					{nRate = 0.2/5.5, Items = {1393}},						--盟主令
					{nRate = 0.2/5.5, Items = {1394}},						--名将令
					{nRate = 0.25/5.5, Items = {1395}},						--逐鹿令
					{nBossId = 634, nRate = 0.5/5.5, Items = {1378}},		--独孤剑同伴
					{nBossId = 1896, nRate = 0.5/5.5, Items = {2253}},		--南宫飞云同伴
					{nBossId = 1897, nRate = 0.5/5.5, Items = {2254}},		--杨影枫同伴
					{nBossId = 2189, nRate = 0.5/5.5, Items = {2255}},		--唐简同伴
					{nRate = 0.2/5.5, Items = {4309}},						--4级金属
					{nRate = 0.5/5.5, Items = {4310}},						--5级金属							
					{nRate = 0.5/5.5, Items = {5821}},						--T11稀有衣服碎片
					{nRate = 1.2/5.5, Items = {1396}},						--帝皇令					
					{nRate = 0.25/5.5, Items = {3462}},						--赤金驭天绳碎片
					{nRate = 0.2/5.5, Items = {3461}},						--苍虹降龙绳碎片
					{nBossId = 634, nRate = 0.5/5.5, Items = {2668}},		--独孤剑魂石
					{nBossId = 1896, nRate = 0.5/5.5, Items = {2880}},		--南宫飞云魂石
					{nBossId = 1897, nRate = 0.5/5.5, Items = {2881}},		--杨影枫魂石
					{nBossId = 2189, nRate = 0.5/5.5, Items = {3897}},		--唐简魂石
