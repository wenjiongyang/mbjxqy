...
Forbid.szBanName = 
{
	[Forbid.BanType.LevelRank] 					= "等級排行榜",
	[Forbid.BanType.FightPowerRank] 			= "戰力排行榜",
	[Forbid.BanType.KinRank] 					= "幫派排行榜",
	[Forbid.BanType.WuShenRank] 				= "武神殿",
	[Forbid.BanType.WuLinMengZhu] 				= "武林盟主",
	[Forbid.BanType.FightPower_Faction] 		= "門派排行榜",
	[Forbid.BanType.FightPower_Equip] 			= "洗練排行榜",
	[Forbid.BanType.FightPower_Strengthen] 		= "強化排行榜",
	[Forbid.BanType.FightPower_Stone] 			= "鑲嵌排行榜",
	[Forbid.BanType.FightPower_Partner] 		= "同伴排行榜",
	[Forbid.BanType.CardCollection_1] 			= "凌絕峰收集榜",
	[Forbid.BanType.HouseRank]					= "家園排行榜",
}
