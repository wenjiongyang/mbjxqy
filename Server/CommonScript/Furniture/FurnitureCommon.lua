...
Furniture.tbNormalFurniture =
{
	...
	[2]  = 	{ szName = "櫃子", 			szKey = "TYPE_CUPBOARD", },
	[3]  = 	{ szName = "桌子", 			szKey = "TYPE_DESK", },
	[4]  = 	{ szName = "椅子", 			szKey = "TYPE_CHAIR", },
	[5]  = 	{ szName = "浴盆", 			szKey = "TYPE_BATHTUB", },
	[6]  = 	{ szName = "擺設(大)", 		szKey = "TYPE_STUFF_L", },
	[7]  = 	{ szName = "擺設(中)", 		szKey = "TYPE_STUFF_M", },
	[8]  = 	{ szName = "擺設(小)", 		szKey = "TYPE_STUFF_S", },
	[9]  = 	{ szName = "掛飾", 			szKey = "TYPE_HANG", },
