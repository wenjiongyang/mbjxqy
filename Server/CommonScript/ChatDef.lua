...
ChatMgr.CHAT_NAME_PREFIRX_MAX_KEY = 200; -- 聊天前缀最大ID
...
function ChatMgr:LoadActionBQSetting()
	...
	local tbFileData = Lib:LoadTabFile("Setting/Chat/ChatActionBQ.tab", {ChatID = 1, ActionID = 1, ActionEvent = 1, ActionLoop = 1});
