...
function ActivityQuestion:GetCurQuestionDesc()
    ...
    local szDesc = string.format("找[FFFE0D]%s[-]瞭解江湖(%d/%d)", szName, math.min(self.ANSWER_NUM_MAX, nHadAnswer + 1), self.ANSWER_NUM_MAX)
    return "[常]答題", szDesc
end
