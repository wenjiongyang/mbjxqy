...
{
	--杨瑛
	[633] = "若是有機會，我也想披上那一身紅色的嫁衣。那個“他”，你可知我的心意？#58",    
	--月眉儿
	[97] = "哇！這是哪家的俊男俏女？真是郎才女貌，天生一對！",
	--万金财
	[190] = "如此氣派的迎親隊伍！我得去湊個熱鬧……#6",
	--林更新
	[2326] = "萬叔，已經能聽到迎親隊的奏樂了，我們差不多該動身了。#43",
	--张如梦
	[625] = "先前有幾個孩童在隱香樓前鬼鬼祟祟，俠士的迎親隊可是要多加留意啊！#43",
	--祝子虚
	[1528] = "新婚快樂！防火防盜防熊孩子，少俠可要擔心啊！#116",
	--武僧
	[1829] = "以前師傅常說“山下的女人是老虎”，我倒是願意還俗娶如此漂亮的“老虎”！#13",
	--赵丽颖
	[2279] = "前些日子紅娘在傢俱坊定制了一批上等傢俱，說是要等俠士的成婚紀念日時給個驚喜！#43",
}
...
Wedding.tbTrigger = 
{
	...
	[1] = {	
		nTime = 5,
		tbExe = {
			{szType = "SendNotify", tbParam = {szMsg = "[FFFE0D]「%s」[-]和[FFFE0D]「%s」[-]即將舉行花轎遊城，大家快去[FFFE0D]襄陽城月老[-]那觀禮送祝福、搶喜糖吧，距離開始還有[FFFE0D]3分鐘[-]。", nMinLevel = 1, nMaxLevel = 999}};
		}
	};
	...
	[2] = {	
		nTime = 55,
		tbExe = {
			{szType = "SendNotify", tbParam = {szMsg = "[FFFE0D]「%s」[-]和[FFFE0D]「%s」[-]即將舉行花轎遊城，大家快去[FFFE0D]襄陽城月老[-]那觀禮送祝福、搶喜糖吧，距離開始還有[FFFE0D]2分鐘[-]。", nMinLevel = 1, nMaxLevel = 999}};
		}
	};
	...
	[3] = {	
		nTime = 60,
		tbExe = {
			{szType = "SendNotify", tbParam = {szMsg = "[FFFE0D]「%s」[-]和[FFFE0D]「%s」[-]即將舉行花轎遊城，大家快去[FFFE0D]襄陽城月老[-]那觀禮送祝福、搶喜糖吧，距離開始還有[FFFE0D]1分鐘[-]。", nMinLevel = 1, nMaxLevel = 999}};
		}
	};
	...
	[4] = {	
		nTime = 59,
		tbExe = {
			{szType = "SendNotify", tbParam = {szMsg = "[FFFE0D]「%s」[-]和[FFFE0D]「%s」[-]正在[FFFE0D]襄陽城[-]舉行花轎遊城，大家快去觀禮送祝福、搶喜糖吧。", nMinLevel = 1, nMaxLevel = 999}};
		}
	};
	...
	[10] = {	
		nTime = 15,
		tbExe = {
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2386, szBubble = "新婚快樂，百年好合！#66#66#66#66#66#66#66", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2387, szBubble = "新婚快樂，百年好合！#66#66#66#66#66#66#66", szBubbleTime = "10"}};
		}
	};
	...
	[11] = {	
		nTime = 15,
		tbExe = {
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2386, szBubble = "花轎準備就緒，等待良時起轎。#124#124", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2387, szBubble = "花轎準備就緒，等待良時起轎。#124#124", szBubbleTime = "10"}};
		}
	};
	...
	[12] = {	
		nTime = 15,
		tbExe = {
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2386, szBubble = "新娘好漂亮啊，等我長大了我也要這麼美美噠！#13#13", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2387, szBubble = "新娘好漂亮啊，等我長大了我也要這麼美美噠！#13#13", szBubbleTime = "10"}};
		}
	};
	...
	[13] = {	
		nTime = 15,
		tbExe = {
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2386, szBubble = "有情人終成眷屬呐！祝你們恩恩愛愛，甜甜美美！#11#11#11", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2387, szBubble = "有情人終成眷屬呐！祝你們恩恩愛愛，甜甜美美！#11#11#11", szBubbleTime = "10"}};
		}
	};
	...
	[14] = {	
		nTime = 15,
		tbExe = {
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2386, szBubble = "良時已到，準備起轎！#124#124#124", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2387, szBubble = "良時已到，準備起轎！#124#124#124", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2388, szBubble = "良時已到，準備起轎！#124#124#124", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2376, szBubble = "良時已到，準備起轎！#124#124#124", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2390, szBubble = "良時已到，準備起轎！#124#124#124", szBubbleTime = "10"}};
		}
	};
	...
	[15] = {	
		nTime = 15,
		tbExe = {
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2386, szBubble = "起轎~#124#124#124", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2387, szBubble = "起轎~#124#124#124", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2388, szBubble = "起轎~#124#124#124", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2376, szBubble = "起轎~#124#124#124", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2390, szBubble = "起轎~#124#124#124", szBubbleTime = "10"}};
		}
	};
	...
	[16] = {	
		nTime = 1,
		tbExe = {
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2386, szBubble = "今日結成幸福侶，畢生共繪錦繡圖！祝你們幸福美滿。#11#11#11", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2387, szBubble = "今日結成幸福侶，畢生共繪錦繡圖！祝你們幸福美滿。#11#11#11", szBubbleTime = "10"}};
		}
	};
	...
	[17] = {	
		nTime = 1,
		tbExe = {
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2386, szBubble = "百年修得同船渡，千年修得共枕眠！祝你們恩恩愛愛。#11#11#11", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2387, szBubble = "百年修得同船渡，千年修得共枕眠！祝你們恩恩愛愛。#11#11#11", szBubbleTime = "10"}};
		}
	};
	...
	[18] = {	
		nTime = 1,
		tbExe = {
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2386, szBubble = "新婚永結同心果，燕爾欣成並蒂花！祝你們永結同心。#11#11#11", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2387, szBubble = "新婚永結同心果，燕爾欣成並蒂花！祝你們永結同心。#11#11#11", szBubbleTime = "10"}};
		}
	};
	...
	[19] = {	
		nTime = 1,
		tbExe = {
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2386, szBubble = "鴛鴦比翼新婚樂，龍鳳呈祥花燭輝！祝你們白頭偕老。#11#11#11", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2387, szBubble = "鴛鴦比翼新婚樂，龍鳳呈祥花燭輝！祝你們白頭偕老。#11#11#11", szBubbleTime = "10"}};
		}
	};
	...
	[20] = {	
		nTime = 1,
		tbExe = {
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2386, szBubble = "連理枝頭蝶對舞，碧空萬里鸞鳳鳴！祝你們百年好合。#11#11#11", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2387, szBubble = "連理枝頭蝶對舞，碧空萬里鸞鳳鳴！祝你們百年好合。#11#11#11", szBubbleTime = "10"}};
		}
	};
	...
	[101] = {	
		nTime = 12,
		tbExe = {
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "wanjincai", nNpcTId = 2624, szBubble = "少俠莫要緊張，我萬某可不是來搶親的哦！#6", szBubbleTime = "8"}};
		}
	};
	...
	[102] = {	
		nTime = 8,
		tbExe = {
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "lingengxin", nNpcTId = 2625, szBubble = "哈哈~這事也就只有財大氣粗的萬叔能辦到。#121", szBubbleTime = "8"}};
		}
	};
	...
	[103] = {	
		nTime = 8,
		tbExe = {
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "wanjincai", nNpcTId = 2624, szBubble = "聽聞二位今日成婚，我特差人提前在此佈置了煙花盛宴，以賀二位新婚快樂……#2", szBubbleTime = "8"}};
		}
	};
	...
	[104] = {	
		nTime = 8,
		tbExe = {
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "lingengxin", nNpcTId = 2625, szBubble = "為了此事，我和萬叔可沒少奔波哦！#23", szBubbleTime = "8"}};
		}
	};
	...
	[105] = {	
		nTime = 8,
		tbExe = {
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "wanjincai", nNpcTId = 2624, szBubble = "萬某祝二位永結同心、白頭偕老！#58", szBubbleTime = "8"}};
		}
	};
	...
	[106] = {	
		nTime = 8,
		tbExe = {
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "lingengxin", nNpcTId = 2625, szBubble = "在下也祝二位幸福美滿、恩恩愛愛！#58", szBubbleTime = "8"}};
		}
	};
	...
	[107] = {	
		nTime = 8,
		tbExe = {
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "wanjincai", nNpcTId = 2624, szBubble = "燃放煙花~#69#69", szBubbleTime = "8"}};
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "lingengxin", nNpcTId = 2625, szBubble = "燃放煙花~#69#69", szBubbleTime = "8"}};
	...
	[108] = {	
		nTime = 8,
		tbExe = {
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "wanjincai", nNpcTId = 2624, szBubble = "煙花盛宴已結束，萬某先行告辭，再次祝二位新婚快樂！", szBubbleTime = "8"}};
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "lingengxin", nNpcTId = 2625, szBubble = "告辭~", szBubbleTime = "8"}};
		}
	};
	...
	[120] = {	
		nTime = 2,
		tbExe = {
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2386, szBubble = "[FFFE0D]喜糖[-]已經準備好了，新郎新娘可以派喜糖啦！#10#10#10#10", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2387, szBubble = "[FFFE0D]喜糖[-]已經準備好了，新郎新娘可以派喜糖啦！#10#10#10#10", szBubbleTime = "10"}};
	...
	[121] = {	
		nTime = 10,
		tbExe = {
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2386, szBubble = "派喜糖時間持續[FFFE0D]90秒[-]哦，新郎新娘快派喜糖吧！#10#10#10#10", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2387, szBubble = "派喜糖時間持續[FFFE0D]90秒[-]哦，新郎新娘快派喜糖吧！#10#10#10#10", szBubbleTime = "10"}};
		}
	};
	...
	[122] = {	
		nTime = 184,
		tbExe = {
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2386, szBubble = "準備起轎~", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2387, szBubble = "準備起轎~", szBubbleTime = "10"}};
		}
	};
	--撒喜糖结束，提示花轿继续
	[123] = {	
	...
	[200] = {	
		...
		tbExe = {
			...
			--剧情人物从镜头外移动到玩家镜头内
			{szType = "TempNpcGoAndTalk", tbParam = {szGroup = "xiaoziyan",  nX = 9588, nY = 11827, nDir = 0, szBubble = "好氣派的婚禮啊！#10"}};
			{szType = "TempNpcGoAndTalk", tbParam = {szGroup = "xiaoyinfang", nX = 9758, nY = 12280, nDir = 30, szBubble = "哇！好漂亮的新娘啊~#13"}};
			{szType = "TempNpcGoAndTalk", tbParam = {szGroup = "xiaoyintong", nX = 9755, nY = 11828, nDir = 0, szBubble = "我也想當新娘……#10"}};
		}
	};
	...
	[201] = {	
		nTime = 14,
		tbExe = {
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "xiaoyintong", nNpcTId = 2628, szBubble = "呐~其實呢，我們是來送祝福的喲，小紫煙你先說。#32", szBubbleTime = "8"}};
		};
	};
	[202] = {	
		nTime = 8,
		tbExe = {
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "xiaoziyan", nNpcTId = 2626, szBubble = "小紫煙祝新郎越來越帥，新娘越來越美！#118", szBubbleTime = "8"}};
		};
	};
	...
	[203] = {	
		nTime = 8,
		tbExe = {
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "xiaoziyan", nNpcTId = 2626, szBubble = "有空常來我家聽雨舫做客哦~#1", szBubbleTime = "8"}};
		};
	};
	...
	[204] = {	
		nTime = 8,
		tbExe = {
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "xiaoyinfang", nNpcTId = 2626, szBubble = "新郎憑什麼能娶到這麼漂亮的新娘？哼！可敢與我上比武台比劃比劃？#119", szBubbleTime = "8"}};
		};
	};
	...
	[205] = {	
		nTime = 8,
		tbExe = {
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "xiaoyintong", nNpcTId = 2628, szBubble = "#30小殷童？別打岔，按咱們事先說好的進行……", szBubbleTime = "8"}};
		};
	};
	...
	[206] = {	
		nTime = 8,
		tbExe = {
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "xiaoyinfang", nNpcTId = 2626, szBubble = "好吧好吧~小殷方也祝新郎新娘恩恩愛愛，白頭偕老！#124", szBubbleTime = "8"}};
		};
	};
	...
	[207] = {	
		nTime = 8,
		tbExe = {
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "xiaoyintong", nNpcTId = 2628, szBubble = "呐~小殷童祝新郎新娘永結同心、百年好合哦！#12", szBubbleTime = "8"}};
		};
	};
	...
	[208] = {	
		nTime = 8,
		tbExe = {
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "xiaoyintong", nNpcTId = 2628, szBubble = "#116嘻嘻~好戲還在後頭呢，小殷方、小紫煙，準備一下……", szBubbleTime = "8"}};
		};
	};
	...
	[212] = {	
		nTime = 5,
		tbExe = {
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "xiaoziyan", nNpcTId = 2626, szBubble = "新婚快樂~#66#66", szBubbleTime = "8"}};
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "xiaoyinfang", nNpcTId = 2626, szBubble = "新婚快樂~#66#66", szBubbleTime = "8"}};
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "xiaoyintong", nNpcTId = 2628, szBubble = "新婚快樂~#66#66", szBubbleTime = "8"}};
		};
	};
	...
	[213] = {	
		nTime = 5,
		tbExe = {
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "xiaoziyan", nNpcTId = 2626, szBubble = "驚不驚喜？#116", szBubbleTime = "8"}};
	...
	[214] = {	
		nTime = 8,
		tbExe = {
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "xiaoyintong", nNpcTId = 2628, szBubble = "這可是我們纏著萬老頭，千辛萬苦才弄到手的煙花哦！#115", szBubbleTime = "5"}};
		};
	};
	...
	[215] = {	
		nTime = 8,
		tbExe = {
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "xiaoziyan", nNpcTId = 2626, szBubble = "嘻嘻~祝福也祝福過了，煙花也放了，言歸正傳，我們是來討喜糖的！#119", szBubbleTime = "8"}};
		};
	};
	...
	[216] = {	
		nTime = 8,
		tbExe = {
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "xiaoyinfang", nNpcTId = 2627, szBubble = "對對對，喜糖呢？不派喜糖我們就賴著不走了。#115", szBubbleTime = "8"}};
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "xiaoyintong", nNpcTId = 2628, szBubble = "糖糖糖，我們要喜糖~#115", szBubbleTime = "8"}};
		};
	};
	...
	[217] = {	
		nTime = 8,
		tbExe = {
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "xiaoziyan", nNpcTId = 2626, szBubble = "糖糖糖，快點派喜糖~#125", szBubbleTime = "8"}};
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "xiaoyinfang", nNpcTId = 2627, szBubble = "糖糖糖，快點派喜糖~#125", szBubbleTime = "8"}};
			{szType = "TempNpcBubbleTalk", tbParam = {szGroup = "xiaoyintong", nNpcTId = 2628, szBubble = "糖糖糖，快點派喜糖~#125", szBubbleTime = "8"}};
		};
	};
	...
	[232] = {	
		nTime = 241,
		tbExe = {
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2386, szBubble = "準備起轎回程~", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2387, szBubble = "準備起轎回程~", szBubbleTime = "10"}};
		}
	};
	--撒喜糖结束，提示花轿继续
	[233] = {	
		nTime = 15,
		tbExe = {
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2386, szBubble = "起轎回程~#124#124#124", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2387, szBubble = "起轎回程~#124#124#124", szBubbleTime = "10"}};
			{szType = "EndCandy"};
		}
	};
	...
	[300] = {	
		nTime = 2,
		tbExe = {
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2386, szBubble = "請新郎新娘登上[FFFE0D]三生舫[-]，舉行[FFFE0D]舫舟·乘龍配鳳[-]婚禮。#66#66", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2387, szBubble = "請新郎新娘登上[FFFE0D]三生舫[-]，舉行[FFFE0D]舫舟·乘龍配鳳[-]婚禮。#66#66", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2388, szBubble = "請新郎新娘登上[FFFE0D]三生舫[-]，舉行[FFFE0D]舫舟·乘龍配鳳[-]婚禮。#66#66", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2376, szBubble = "請新郎新娘登上[FFFE0D]三生舫[-]，舉行[FFFE0D]舫舟·乘龍配鳳[-]婚禮。#66#66", szBubbleTime = "10"}};
			{szType = "NpcBubbleTalk", tbParam = {nNpcTId = 2390, szBubble = "請新郎新娘登上[FFFE0D]三生舫[-]，舉行[FFFE0D]舫舟·乘龍配鳳[-]婚禮。#66#66", szBubbleTime = "10"}};
		}
	};
...
Wedding.tbProposeLegalMap = {10,999,1004} 															-- 可求婚地图
...
Wedding.szProposeTimeoutTip = "「%s」也許正沉浸在突如其來的幸福中，一時未作出回應" 					-- 求婚者超时拒绝提示
Wedding.szBeProposeTimeoutTip = "不要只顧沉浸在幸福中！要記得及時同意「%s」的求婚哦！"				-- 被求婚者超时拒绝提示
Wedding.szProposeSuccessTip = "今日結成幸福侶，畢生共繪錦繡圖。祝福兩位情定此生！" 					-- 求婚者成功提示
Wedding.szBeProposeSuccessTip = "今日結成幸福侶，畢生共繪錦繡圖。祝福兩位情定此生！" 				-- 被求婚者同意求婚提示
Wedding.szProposeSuccessNotify = "相遇于劍俠，相識于江湖，緣起於情緣，緣定於今生。恭喜[FFFE0D]「%s」[-]向[FFFE0D]「%s」[-]求婚成功，祝有情人終成眷屬！"					-- 求婚成功滚屏公告
Wedding.szProposeFailTip = "「%s」也許還未做好準備，拒絕了你的求婚"									-- 求婚者拒绝提示
Wedding.szBeProposeFailTip = "你拒絕了「%s」的求婚" 												-- 被求婚者拒绝求婚提示
Wedding.szProposeBreakTip = "求婚中斷啦，有些耐心，過程中要靜靜等待對方答覆哦！"								-- 求婚过程中主动打断的提示（切地图，离线，重登等）
Wedding.szProposeBeBreakTip = "「%s」也許是有些害羞，鼓起勇氣再嘗試一次吧！" 						-- 求婚过程中对方打断的提示（切地图，离线，重登等）
Wedding.tbProposePromise = 																			-- 求婚誓言模板
{
	"[ff72c5]願得一人心，白首不相離！\n[-]親愛的[c8fe00]%s[-]，我們在一起吧\n願與您攜手共度劍俠的每一天！";
	"[ff72c5]身無彩鳳雙飛翼，心有靈犀一點通！\n[-]親愛的[c8fe00]%s[-]，弱水三千，只取一瓢\n之所以執劍成俠，只為守護一世情緣！";
	"[ff72c5]金風玉露一相逢，便勝卻人間無數！\n[-]親愛的[c8fe00]%s[-]，與你相遇無比幸運\n而最大的幸運，就是能與你相守一生！";
	"[ff72c5]在天願作比翼鳥，在地願為連理枝！\n[-]親愛的[c8fe00]%s[-]，無論何時，無論何地\n我都會牢牢牽著你的手，永不分離！";
	"[ff72c5]兩情若是久長時，又豈在朝朝暮暮！\n[-]親愛的[c8fe00]%s[-]，我只是個平凡的人\n別無他求，只求朝朝暮暮與你在一起！";
}
...
Wedding.szxLoliGrowUpMsg = "穿上這身嫁衣，從此就長大成人啦" 										-- 进婚礼现场之后的提示
...
Wedding.tbWeddingLevelMapSetting = {
	...
	[Wedding.Level_2] = {
		...
		szFullDate = "明天";	
		szCurDate = "今天";																																				-- 					
		szStartWeddingTip = "確定要現在舉行[FFFE0D]海島·紅鸞攬月[-]婚禮嗎？\n[FFFE0D]提示：婚禮時長大約為27分鐘[-]";
		nReplayMapTId = 5004;
		tbTrapInfo = 
		{
	...
	[Wedding.Level_3] = {
		...
		szFullDate = "下周";
		szCurDate = "本周";
		szStartWeddingTip = "確定要現在舉行[FFFE0D]舫舟·乘龍配鳳[-]婚禮嗎？\n[FFFE0D]提示：婚禮時長大約為45分鐘[-]";
		nReplayMapTId = 5005;
		tbTrapInfo = 
		{
...
Wedding.szPromiseStartTip = "愛要大聲說出來！下面有請「%s」和「%s」寫下愛的誓言" 									-- 宣誓开始月老喊话
Wedding.szPromiseDefault = "生死契闊，與子相悅，執子之手，與子偕老。" 												-- 玩家没自定义默认誓言
...
Wedding.szPromiseNotice = "%s[FFFE0D]「%s」[-]在[FFFE0D]%s[-]婚禮上向%s[FFFE0D]「%s」[-]許下山盟海誓：“%s”"
-- 》》开心爆竹
...
{
	[1]  = "開心爆竹已在[FFFE0D]舞臺[-]點燃，距燃放還有[FFFE0D]%d秒[-]，內藏繡球及隨手禮！";
	[20] = "開心爆竹已在[FFFE0D]舞臺[-]點燃，距燃放還有[FFFE0D]%d秒[-]，內藏繡球及隨手禮！";
	[40] = "開心爆竹已在[FFFE0D]舞臺[-]點燃，距燃放還有[FFFE0D]%d秒[-]，內藏繡球及隨手禮！";
	[50] = "開心爆竹已在[FFFE0D]舞臺[-]點燃，距燃放還有[FFFE0D]%d秒[-]，內藏繡球及隨手禮！";
	[55] = "開心爆竹已在[FFFE0D]舞臺[-]點燃，距燃放還有[FFFE0D]%d秒[-]，內藏繡球及隨手禮！";
}
...
Wedding.szFirecrackerBoomMsg = "新婚快樂，百年好合！" 			 													-- 爆炸之后玩家喊话
...
Wedding.nFirecrackerTitleMsg = "[FFFE0D]「%s」[-]在[FFFE0D]「%s」[-]和[FFFE0D]「%s」[-]婚禮上的開心爆竹環節中幸運奪得繡球，獲得特殊稱號[FF69B4]「花落我家」[-]" 																			-- 特殊称号抽中提示（抽中玩家，男主角，女主角）																			-- 特殊称号没抽中提示（男主角，女主角）
-- 》》同心果
...
Wedding.szConcentricFruitSuccessMsg = "兩位新人心有靈犀，真是天造地設的一對啊！" 									-- 成功喊话
Wedding.szConcentricFruitFailMsg = "實在可惜！只差分毫，兩位新人莫緊張，再試試！" 									-- 失败喊话
-- 》》喜宴
...
Wedding.szCandyFubenThrowMsg = "月老在四周佈置了[FFFE0D]喜糖[-]，希望吃到的俠士也能甜甜蜜蜜"
Wedding.szCandyFubenSendMsg = "「%s」和「%s」感謝大家的祝福，特備[FFFE0D]喜糖[-]一同分享甜蜜"
...
Wedding.szCandyFreeTip = "是否派發喜糖，讓大家一同分享這份甜蜜？\n[FFFE0D]（本次免費）[-]" 									-- 免费派喜糖弹框提示
Wedding.szCandyPayTip = "是否以[FFFE0D]%d元寶[-]購置喜糖贈予賓客，讓大家與你一同分享這份甜蜜？" 				-- 付费派喜糖弹框提示
...
Wedding.szSendCandyTourMsg = "「%s」和「%s」誠摯感謝大家的祝福，特備[FFFE0D]喜糖[-]一同分享這份甜蜜" 																     -- 发喜糖黑条
...
Wedding.tbBlessMsg = 
{
	{"幸福美滿", "今日結成幸福侶，畢生共繪錦繡圖！祝「%s」和「%s」幸福美滿。#124"};
	{"恩恩愛愛", "百年修得同船渡，千年修得共枕眠！祝「%s」和「%s」恩恩愛愛。#11"};
	{"永結同心", "新婚永結同心果，燕爾欣成並蒂花！祝「%s」和「%s」永結同心。#58"};
	{"白頭偕老", "鴛鴦比翼新婚樂，龍鳳呈祥花燭輝！祝「%s」和「%s」白頭偕老。#120"};
	{"百年好合", "連理枝頭蝶對舞，碧空萬里鸞鳳鳴！祝「%s」和「%s」百年好合。#66"};
}
...
function Wedding:CheckProposeC(pPlayer, nPlayerId)
	...
	if not Wedding:IsSingle(pPlayer) then
        return false, string.format("[FFFE0D]「%s」[-]已經成婚或已有訂婚物件", pPlayer.szName)
    end
     if pPlayer.nLevel < Wedding.nProposeLevel then
		return false, string.format("[FFFE0D]「%s」[-]等級需達到 [FFFE0D]%d[-] 級", pPlayer.szName, Wedding.nProposeLevel)
	end
	 if not Wedding.tbAllProposeLegalMap[pPlayer.nMapTemplateId] and not Map:IsHouseMap(pPlayer.nMapTemplateId) then
        return false, string.format("[FFFE0D]「%s」[-]所在場景不允許求婚，請在[FFFE0D]忘憂島、襄陽城、家園、幫派屬地[-]進行", pPlayer.szName)
    end
    if nPlayerId then
...
function Wedding:CheckOpenTime()
	...
	if nTodayTime < (nStartHour * 3600 + nStartMin * 60) or nTodayTime > (nEndHour * 3600 + nEndMin * 60) then
		return false, "只能在每天的[FFFE0D]10:00~24:00時間段[-]舉行婚禮"
	end
	return true
end
...
function Wedding:CheckDelFriend(dwRoleId1, dwRoleId2)
	if self:IsEngaged(dwRoleId1, dwRoleId2) then
		return false, "訂婚關係不能刪除好友"
	end
	if self:IsLover(dwRoleId1, dwRoleId2) then
		return false, "結婚關係不能刪除好友"
	end
	return true
end
...
function Wedding:CheckOpenProposeTime()
	local nNowTime = GetTime()
	return nNowTime > (Wedding.nProposeOpenDate or 0), "暫未開放"
end
