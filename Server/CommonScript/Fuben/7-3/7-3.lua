...
tbFubenSetting.LOCK = 
{
	...
	[2] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu", "束手就擒吧，別無謂掙扎了！", 4, 0, 1},
			{"BlackMsg", "看來此處已被五色教佔領了！"},
	...
	[14] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "BOSS", "這次算你們狠，我們後會有期！", 4, 0, 1},
	...
	[18] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"BlackMsg", "擊敗封玉書及其走狗！"},
			{"NpcBubbleTalk", "BOSS", "兄弟們出來幫忙啊！", 4, 1, 1},
