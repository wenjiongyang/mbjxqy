...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 5,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu1", "兄弟們，有肥羊來了！大夥一起上啊！", 4, 1, 1},			
		},
			tbUnLockEvent = 
		{
			{"AddAnger", 150}, 		
	...
	[6] = {nTime = 0, nNum = 4,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu2", "不知死活的傢伙，我馬上送你去見閻王！", 4, 1, 1},			
		},
			tbUnLockEvent = 
		{
			{"AddAnger", 150}, 
	...
	[21] = {nTime = 1.5, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "BOSS", "可惜一個嬌滴滴的女子卻要舞劍弄槍......", 4, 0.5, 1},
		},
	},
	...
	[23] = {nTime = 4, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "BOSS", "哪來的野小子，敢破壞大爺的好事。找死！", 4, 2, 1},
		},
		tbUnLockEvent = 
		{
	...
	[25] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "BOSS", "算你小子運氣好！", 4, 0, 1},
		},
		tbUnLockEvent = 
		{
			{"GameWin"},
