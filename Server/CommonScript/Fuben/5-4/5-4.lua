...
tbFubenSetting.LOCK = 
{
	...
	[14] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc1", "你……就是那個姚，姚什麼東西？", 4, 0.5, 1},
	...
	[16] = {nTime = 2, nNum = 0,
		...
		{
			{"SetNpcDir", "npc1", 56},
			{"NpcBubbleTalk", "npc1", "姑娘還不走？", 4, 0.5, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[20] = {nTime = 4, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "boss", "大、大爺，不，幹、乾爹...饒命啊！", 3, 0, 1},
			{"NpcBubbleTalk", "npc1", "嘿嘿，好乾兒子，你做的壞事已經夠你死一千次了，饒你不得！", 4, 2, 1},
