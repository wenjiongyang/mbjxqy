...
tbFubenSetting.LOCK = 
{
	...
	[14] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc", "張大哥，小弟得罪了。", 4, 0, 1},
			{"NpcBubbleTalk", "npc1", "好……好劍法！張某佩……佩服！", 4, 2, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[19] = {nTime = 5, nNum = 0,
		...
		tbStartEvent = 
		{
			{"OpenWindowAutoClose", "StoryBlackBg", "南宮彩虹忽然出現將獨孤劍擊暈在地，然後救走了張如夢......", nil, 2, 2, 1},
		},
		tbUnLockEvent = 
		{
