...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbStartEvent = 
		{
			{"BlackMsg", "這迷宮如此陰森，看來得小心查探了！"},
			{"RaiseEvent", "PartnerSay", "好冷！陰風蝕骨！", 3, 1},
		},
	...
	[4] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"RaiseEvent", "PartnerSay", "這裡好多蜘蛛啊！", 3, 1},
			{"BlackMsg", "擊敗怪物，找到出路！"},
	...
	[11] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"RaiseEvent", "PartnerSay", "這個蠍子是修煉成精了麼？如此之大！", 3, 1},
			{"BlackMsg", "擊敗巨型蠍子，離開此處！"},
		},
		tbUnLockEvent = 
		{
		},
