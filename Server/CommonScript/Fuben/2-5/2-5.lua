...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu1", "楊影楓，跟我們走！", 4, 1, 1},
		},
		tbUnLockEvent = 
		{
			--{"NpcBubbleTalk", "Start_Npc1", "飞龙堡的人...怎么二话不说就动手！", 4, 0, 1},
			{"RaiseEvent", "PartnerSay", "飛龍堡的人...怎麼二話不說就動手！", 4, 1},
	...
	[5] = {nTime = 0, nNum = 9,
		...
		tbUnLockEvent = 
		{
			...
			{"RaiseEvent", "PartnerSay", "沒想到飛龍堡行事作風竟如此霸道....", 4, 1},
		},
	},
	...
	[7] = {nTime = 0, nNum = 12,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "BOSS", "我已在沿途設下埋伏，閣下還是束手就擒吧！", 5, 0, 1},
		},
		tbUnLockEvent = 
		{
	...
	[9] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "BOSS", "看來你們真的還有兩下子，別怪我下狠手了！", 3, 0, 1},
			{"NpcBubbleTalk", "Start_Npc1", "廢話少說，打倒在下自然跟你走！", 4, 3, 1},
...
-------------------------------------------------------
	...
	[33] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "BOSS", "你就乖乖跟兄弟們走一趟吧！", 4, 1, 1},
			--{"NpcBubbleTalk", "Start_Npc1", "哼，想让杨某跟你们走，就先问问我手中之剑答不答应！", 4, 3, 1},
			{"RaiseEvent", "PartnerSay", "哼，想讓我們跟你走，先問問我手中的武器答不答應！", 4, 1},
		},
	},
	...
	[35] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			{"SetNpcProtected", "BOSS", 1},
			{"SetNpcBloodVisable", "BOSS", false, 0},
			{"NpcBubbleTalk", "BOSS", "讓我的兄弟來收拾你們！", 4, 0, 1},
			...
			{"NpcBubbleTalk", "guaiwu1", "兄弟們，給我將他們綁回飛龍堡！", 4, 2, 1},
		},
		tbUnLockEvent = 
		{
			{"NpcAddBuff", "BOSS", 2452, 1, 100},
