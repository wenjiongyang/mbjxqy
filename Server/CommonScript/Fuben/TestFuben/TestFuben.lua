...
--								参数：{门派特效1, 门派特色2} 特效资源 Id, nX 坐标 X（填 0 或者不填，则表示使用玩家当前坐标）, nY 坐标 Y（填 0 或者不填，则表示使用玩家当前坐标）, nZ 高度 （不填则表示 0）,bRenderPos(原点时填1)
--								实例：{"PlayFactionEffect", {1, 2, 3, 4}},
...
--								参数：bForbidden 是否禁止玩家操作， 是否不禁止摇杆
...
-- OpenGuide					说明：打开指引
--								参数：解锁的ID, 指引的箭头 文字描述 窗口名称 控件名称 偏移位置  是否不可点击操作界面  是否黑屏 是否要隐藏跳过引导按钮
--								示例：{"OpenGuide", nil, "PopT", "xxx", "HomeScreenBattle", "Attack", {10, 10}, true, true, true},
...
tbFubenSetting.LOCK =
{
	...
	[2] = {nTime = 0, nNum = 1,
			...
			tbUnLockEvent =
		{
			...
			{"BlackMsg", "你身上有八哥！我要對你進行紛爭根絕！武力介入開始！"},
	...
	[3] = {nTime = 0, nNum = "NpcNum1",
			...
			tbUnLockEvent =
		{
			...
			{"BlackMsg", "西南方傳來了一段話：女施主，等等，面試完這個就到你了"},
	...
	[4] = {nTime = 0, nNum = "NpcNum2",		-- 总计时
		...
		tbUnLockEvent =
		{
			...
			{"BlackMsg", "這個應該很簡單的吧？這裡改一下就好了啊！你惹怒了他們！"},
	...
	[5] = {nTime = 0, nNum = "NpcNum3",
		...
		tbUnLockEvent =
		{
			...
			{"BlackMsg", "南方忽然傳來了一道聲音：來人啊！抓住吊起來打！"},
	...
	[6] = {nTime = 0, nNum = "NpcNum4",
		...
		tbUnLockEvent =
		{
			{"BlackMsg", "東邊忽然出現了一股靈壓…這查克拉的感覺…馬薩卡…"},
	...
	[8] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent =
		{
			{"BlackMsg", "哈哈哈！天真！那只是本座的小夥伴分身！再來揍我啊！"},
