...
tbFubenSetting.LOCK = 
{
	...
	[2] = {nTime = 0, nNum = 1,
			...
			tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu", "小子，這塊地方已經被我們承包了！不想死的話趕緊滾！", 4, 1, 1},
		},
	},
	[3] = {nTime = 0, nNum = 8,
		tbPrelock = {2},
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "Start_Npc1", "他們究竟是什麼人，出現在這裡有什麼目的？", 4, 0, 1},
		},
	},
	[4] = {nTime = 0, nNum = 1,
		tbPrelock = {3},
	...
	[5] = {nTime = 0, nNum = 6,		-- 总计时
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "Start_Npc1", "這群人似乎正在搜尋什麼東西？莫非....", 4, 0, 1},
		},
	},
	[6] = {nTime = 0, nNum = 1,
		tbPrelock = {5},
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu", "哪裡來的傢伙，竟敢阻礙本教辦事！真是找死！", 4, 1, 1},
		},
	},
	[7] = {nTime = 0, nNum = 10,
		tbPrelock = {6},
	...
	[11] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "Start_Npc1", "什麼人？", 4, 0, 1},
			{"NpcBubbleTalk", "BOSS", "哈哈，踏破鐵鞋無覓處，得來全不費功夫！", 4, 0, 1},
		},
		tbUnLockEvent = 
		{
	...
	[14] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"SetNpcBloodVisable", "Start_Npc1", false, 0},
			{"NpcBubbleTalk", "Start_Npc1", "我要為我師傅報仇！", 4, 0, 1},
