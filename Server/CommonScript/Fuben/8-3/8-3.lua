...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"RaiseEvent", "PartnerSay", "有人來了！", 3, 1},
		},
		tbUnLockEvent = 
		{
			{"RaiseEvent", "PartnerSay", "不堪一擊...", 3, 1},
			{"BlackMsg", "繼續前進"},
	...
	[6] = {nTime = 0, nNum = 9,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw1", "來者何人？擅闖官府重地，綁起來！", 4, 1, 1},
		},
		tbUnLockEvent = 
		{
			{"RaiseEvent", "PartnerSay", "大言不慚！", 3, 1},
			{"BlackMsg", "繼續前進"},
	...
	[8] = {nTime = 0, nNum = 12,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw1", "兄弟們一起上，有重賞！", 4, 1, 1},
		},
		tbUnLockEvent = 
		{
			{"RaiseEvent", "PartnerSay", "重賞之下，必有勇夫啊，哈哈！", 3, 1},
			{"BlackMsg", "繼續前進"},
	...
	[10] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw1", "殺啊！", 4, 1, 1},
			{"NpcBubbleTalk", "sl", "有兩下子，居然闖到此處，找死！", 4, 1, 1},
		},
		tbUnLockEvent = 
		{
		},
