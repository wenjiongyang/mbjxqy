...
tbFubenSetting.LOCK = 
{
	...
	[6] = {nTime = 0, nNum = 8,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "npc", "看來此處很不平靜！", 4, 0, 1},
	...
	[12] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc", "我們先離開吧！", 3, 0, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[14] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			{"OpenWindowAutoClose", "StoryBlackBg", "忽然周圍出現一大群無憂教徒，將你們團團圍住", nil, 2, 1, 1},
			...
			{"NpcBubbleTalk", "sl", "嘿嘿，還想走？天真！", 6, 3, 1},
	...
	[15] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "sl", "楊影楓，你還想輕舉妄動？", 3, 0, 1},
	...
	[16] = {nTime = 0, nNum = 1,
		...
		{
			{"SetForbiddenOperation", true},
			{"NpcBubbleTalk", "sl", "想救她們的話就來摘星樓吧。", 3, 0, 1},
	...
	[19] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc", "我還是先去落葉谷找孟老前輩幫忙吧。", 3, 0, 1},
		},
		tbUnLockEvent = 
		{
	...
	[21] = {nTime = 6, nNum = 0,
		...
		tbStartEvent = 
		{
			{"SetForbiddenOperation", true},
			{"SetAllUiVisiable", false},
			{"NpcBubbleTalk", "gw1", "什麼人？", 3, 0, 1},
			{"SetNpcDir", "gw1", 64},
			{"NpcBubbleTalk", "gw1", "好大的膽子，擅闖無憂禁地！", 3, 2, 1},
			{"NpcBubbleTalk", "gw1", "讓你們嘗嘗我禁地機關的厲害！", 4, 4, 1},
