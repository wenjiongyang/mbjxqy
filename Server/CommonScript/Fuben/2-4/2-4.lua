...
tbFubenSetting.LOCK = 
{
	...
	[2] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Yangyingfeng", "這心魔陣有些詭異....", 3, 0, 1},
	...
	[3] = {nTime = 0, nNum = 1,
		...
		{	
			...
			{"BlackMsg", "卓非凡！為何他會出現在這裡？"},
			{"NpcBubbleTalk", "Zhuofeifan", "賢弟，一向可好？", 3, 0, 1},
			{"NpcBubbleTalk", "Yangyingfeng", "卓非凡！不必在我面前偽裝了，我們刀劍下見真章！", 3, 2, 1},
			{"NpcBubbleTalk", "Zhuofeifan", "賢弟，這是何故？", 3, 4, 1},
			{"NpcBubbleTalk", "Yangyingfeng", "哼，卓非凡，你還真是健忘！今天我要你血債血還！", 3, 6, 1},
			{"NpcBubbleTalk", "Zhuofeifan", "賢弟，你我身為結拜兄弟，為何卻要兵戎相見！！", 4, 8, 1},
			{"NpcBubbleTalk", "Yangyingfeng", "卓非凡，當日你準備加害我時，又可曾想起過兄弟之情！", 4, 10, 1},
			{"NpcBubbleTalk", "Yangyingfeng", "廢話少說，我們今日就來做個了斷吧！", 4, 13, 1},
		},
	},
	[4] = {nTime = 10, nNum = 0,
		tbPrelock = {3},
	...
	[6] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"BlackMsg", "繼續探索心魔陣！"},
			{"NpcBubbleTalk", "Yangyingfeng", "這到底是怎麼回事.......", 6, 0, 1},
		},
	},
	[7] = {nTime = 0, nNum = 1,
		tbPrelock = {6},
	...
	[8] = {nTime = 8, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "Yangyingfeng1", "這裡是... 芭蕉小築？！！", 3, 2, 1},
			{"NpcBubbleTalk", "Yangyingfeng1", "紫.... 紫軒！！！", 3, 4, 1},
			{"NpcBubbleTalk", "Zixuan", "楊大哥，快救我！", 3, 6, 1},
			{"NpcBubbleTalk", "Yangyingfeng1", "紫軒！紫軒！你怎麼啦？", 3, 8, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[9] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"BlackMsg", "與楊影楓聯手擊敗奪命一點金！"},
			{"NpcBubbleTalk", "Yangyingfeng1", "哼，哪裡來的賊人，光天化日之下竟敢強搶民女！", 3, 0, 1},
			{"NpcBubbleTalk", "guaiwu", "哪裡來的小子，竟敢妨礙本大爺辦事真是找死！兄弟們，給我上！！！", 3, 2, 1},
	...
	[10] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"BlackMsg", "繼續探索心魔陣！"},
			{"NpcBubbleTalk", "Yangyingfeng1", "紫軒............", 4, 0, 1},
		},
	},
	[11] = {nTime = 0, nNum = 1,
		tbPrelock = {9},
	...
	[23] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "Yangyingfeng2", "真兒，等等......不對......這還是我的心魔......", 3, 1.5, 1},
		},
		tbUnLockEvent = 
		{
		},
