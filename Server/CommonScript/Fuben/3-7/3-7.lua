...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 1,
			...
			tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "menwei", "想要見到教主，先過我這關！", 3, 0.5, 1},
	...
	[5] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu1", "今日定叫你有來無回！！", 4, 0.5, 1},
		},
	},
	[6] = {nTime = 0, nNum = 7,
		tbPrelock = {5},
	...
	[8] = {nTime = 0, nNum = 1,
		...
		--	{"AddNpc", 7, 4, 9, "guaiwu3", "Stage_3_4", 1, -1, 6, 0, 0},			
			{"NpcBubbleTalk", "guaiwu3", "大夥一起上，將此人擒下交予教主！", 4, 2, 1},
		},
	},
	[9] = {nTime = 0, nNum = 12,
		tbPrelock = {8},
	...
	[17] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu4", "哪裡來的傢伙，竟敢對教主無理！", 4, 0.5, 1},
			{"NpcBubbleTalk", "BOSS", "楊影楓，就讓你見識一下我無憂教的實力吧！", 4, 0.5, 1},
			{"NpcBubbleTalk", "npc", "納蘭潛凜！今日就讓我來終結你的野心吧！", 4, 3, 1},
	...
	[33] = {nTime = 25, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "BOSS", "真兒……這是我咎由自取……你不要難過了……", 3, 3.5, 1},
			{"NpcBubbleTalk", "npc2", "……爹……", 3, 6.5, 1},
			{"NpcBubbleTalk", "BOSS", "眉兒……你終於肯叫我爹了……", 3, 9.5, 1},
			{"NpcBubbleTalk", "npc3", "爹……你的仇……影楓哥已經替你報了……", 3, 12.5, 1},
			{"NpcBubbleTalk", "npc", "唉……", 3, 15.5, 1},
			{"NpcBubbleTalk", "BOSS", "楊影楓……你要好好待我兩個女兒……否則我……", 3, 18.5, 1},
			{"NpcBubbleTalk", "npc", "你放心，我會的。", 3, 21.5, 1},
	...
	[36] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			{"OpenWindowAutoClose", "BossReferral", "納", "蘭潛凜", "無憂教主、忘憂島主"},
		},
		tbUnLockEvent = 
		{
