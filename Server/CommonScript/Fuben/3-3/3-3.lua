...
tbFubenSetting.LOCK = 
{
	...
	[2] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu1", "你總算是來了！準備好受死吧！！", 4, 1, 1},
			{"BlackMsg", "沒想到這裡竟會有埋伏！"},	
		},
	},
	[3] = {nTime = 0, nNum = 8,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu1", "你已是甕中之鼈！還不乖乖束手就擒！", 4, 1, 1},
		},
	},
	[4] = {nTime = 0, nNum = 5,
		tbPrelock = {3},
		...
		tbUnLockEvent = 
		{
			...
			{"RaiseEvent", "PartnerSay", "沒想到飛龍堡還安排了伏兵...", 4, 1},
	...
	[8] = {nTime = 0, nNum = 12,
		...
		tbUnLockEvent = 
		{
			...
			{"RaiseEvent", "PartnerSay", "月眉兒應該就在前方！", 4, 1},
			{"DoDeath", "wall3"},
	...
	[11] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"SetAiActive", "BOSS", 1},
			{"RaiseEvent", "CloseDynamicObstacle", "ops3"},	
			{"NpcBubbleTalk", "BOSS", "楊影楓，有本事你就殺了我替納蘭真報仇吧！", 4, 2, 1},
			{"NpcBubbleTalk", "Start_Npc1", "月眉兒，你......", 4, 4, 1},
		},
	},
	[12] = {nTime = 0, nNum = 1,
		tbPrelock = {8},
...
-------------------------结束剧情-------------------------
	...
	[18] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc", "不要啊！影楓哥！", 3, 0, 1},
			{"SetAiActive", "npc", 0},
			...
			{"NpcBubbleTalk", "Start_Npc1", "真兒！", 3, 1, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[19] = {nTime = 13, nNum = 0,
		...
		{
			{"SetAiActive", "Start_Npc1", 0},
			{"NpcBubbleTalk", "Start_Npc1", "真兒！原來你沒死！", 3, 1, 1},
			{"NpcBubbleTalk", "npc", "影楓哥！你為什麼要殺月姑娘？", 3, 3, 1},
			{"NpcBubbleTalk", "Start_Npc1", "真兒！不是她把你綁架了嗎？", 3, 5, 1},
			{"NpcBubbleTalk", "npc", "影楓哥！你太糊塗了……", 3, 7, 1},
			{"NpcBubbleTalk", "Start_Npc1", "真兒！這到底是怎麼回事？", 3, 9, 1},
			{"NpcBubbleTalk", "BOSS", "咳咳...", 3, 10, 1},
			{"NpcBubbleTalk", "npc", "先別說了，把月姑娘帶回悲魔山莊救治要緊！", 3, 11, 1},
		},
		tbUnLockEvent = 
		{
