...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 0, nNum = 16,
		...
		tbStartEvent = 
		{
			...
			{"RaiseEvent", "PartnerSay", "風雪山莊人多勢眾啊！", 3, 1},
		},
		tbUnLockEvent = 
		{
			{"RaiseEvent", "PartnerSay", "不過如此嘛。", 3, 1},
			{"BlackMsg", "繼續前進"},
	...
	[6] = {nTime = 0, nNum = 18,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw1", "來者何人？居然到風雪山莊撒野！", 4, 1, 1},
		},
		tbUnLockEvent = 
		{
			{"RaiseEvent", "PartnerSay", "前面怕是有強敵。", 3, 1},
			{"BlackMsg", "繼續前進"},
	...
	[8] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw1", "兄弟們一起上。", 4, 1, 1},
			{"NpcBubbleTalk", "sl", "有兩下子，居然闖到此處！", 4, 1, 1},
		},
		tbUnLockEvent = 
		{
		},
...
----------------------------完结剧情----------------
	...
	[14] = {nTime = 4, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc", "哎呀，我動不了了！！", 4, 0, 1},
			{"NpcBubbleTalk", "npc1", "來人！拿下了！", 4, 2, 1},
		},
		tbUnLockEvent = 
		{
