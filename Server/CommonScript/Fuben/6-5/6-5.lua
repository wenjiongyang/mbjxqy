...
tbFubenSetting.LOCK = 
{
	...
	[14] = {nTime = 8, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "boss", "天堂大路你不走，地獄無門——你自來！好，我就送你們去見兩個死鬼老爹！", 4, 0, 1},
			{"NpcBubbleTalk", "npc", "呸！南宮狗賊，你作惡多端，今日便是你的死期！", 3, 3, 1},
			{"NpcBubbleTalk", "npc1", "我要為父親報仇！", 3, 5, 1},
	...
	[19] = {nTime = 8, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc", "（驚呼）啊？！琳兒！……", 3, 0, 1},
			{"NpcBubbleTalk", "boss", "（咆哮）哼！不自量力就只有死路一條！", 3, 2, 1},
			{"NpcBubbleTalk", "npc", "（瘋狂）你！……我跟你拼了！", 3, 4, 1},
			{"NpcBubbleTalk", "boss", "啊！你……你竟然學會了“天魔解體大法”？！", 3, 6, 1},
		},
		tbUnLockEvent = 
		{
			{"LeaveAnimationState", true},
