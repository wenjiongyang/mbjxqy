...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu", "來者何人，通天塔已歸我無憂教，閒雜人等還不速速退去！？", 4, 2, 1},
		},
			tbUnLockEvent = 
		{
	...
	[4] = {nTime = 0, nNum = 1,
			...
			tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu1", "大膽狂徒，真是活的不耐煩了！", 4, 1, 1},
		},
	},
	[5] = {nTime = 0, nNum = 9,
		tbPrelock = {4},
	...
	[7] = {nTime = 0, nNum = 10,
		...
		{	
			...
			{"NpcBubbleTalk", "guaiwu", "擅闖通天塔，殺無赦！", 4, 2, 2},
		},
		tbUnLockEvent = 
		{
		},
	...
	[8] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "BOSS", "到此為止了！這通天塔可不是你想來能來的地方！", 4, 3, 1},
