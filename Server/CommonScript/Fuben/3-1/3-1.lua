...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "npc1", "有本事就到後面來找我！", 4, 0, 1},
		},
	},
	[100] = {nTime = 1, nNum = 0,
		tbPrelock = {4},
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "npc", "等等，周圍好像有埋伏！", 4, 0, 1},
		},
	},
	[101] = {nTime = 1, nNum = 0,
		tbPrelock = {100},
	...
	[6] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			{"RaiseEvent", "PartnerSay", "此處怪物橫行，這姑娘還亂跑...", 4, 1},
			{"TrapUnlock", "trap2", 6},
	...
	[103] = {nTime = 1, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc1", "我家的鷹兒可是特殊訓練過的，慢慢玩！", 4, 0, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[9] = {nTime = 0, nNum = 8,
		...
		tbUnLockEvent = 
		{
			{"RaiseEvent", "PartnerSay", "好兇悍的鷹...", 4, 1},
	...
	[12] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"SetAiActive", "npc1", 1},
			{"SetAiActive", "gw", 1},
			{"NpcBubbleTalk", "npc1", "看來本姑娘得親自出手了！", 4, 1, 1},
			{"NpcBubbleTalk", "npc", "那楊某就領教薔薇姑娘的高招了！", 4, 2, 1},
