...
tbFubenSetting.LOCK = 
{
	...
	[12] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "yangyingfeng", "這一切都是騙局！騙局！", 3, 0, 1},
			{"SetAllUiVisiable", true}, 
		},
	},
	[13] = {nTime = 300, nNum = 0,
	...
	[30] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Patrol_1", "你是什麼人，竟敢擅闖藏劍山莊！", 4, 0, 1},
	...
	[31] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Patrol_2", "你是什麼人，竟敢擅闖藏劍山莊！", 4, 0, 1},
	...
	[32] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Patrol_3", "你是什麼人，竟敢擅闖藏劍山莊！", 4, 0, 1},
	...
	[33] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Patrol_4", "你是什麼人，竟敢擅闖藏劍山莊！", 4, 0, 1},
