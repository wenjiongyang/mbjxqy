...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"RaiseEvent", "ShowTaskDialog", 4, 1001, false}, 
			{"PauseLock", 18},
		},
	},
	[4] = {nTime = 0, nNum = 1,
	...
	[7] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "guaiwu1", "哈哈，又有肥羊上門了！兄弟們抄傢伙上啊！", 4, 0, 1},
	...
	[9] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "guaiwu", "哪裡來的傢伙，敢妨礙大爺們吃肉！給我宰了他！", 6, 0, 1},
	...
	[21] = {nTime = 3, nNum = 0,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "npc3", "不想死的趕緊給我站住！", 2, 0, 1},
		},
	},
	[22] = {nTime = 5, nNum = 0,
		tbPrelock = {4},
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "npc4", "媽的！讓他們給跑了！", 3, 0, 1},
		},
	},
	[23] = {nTime = 2, nNum = 0,
		tbPrelock = {22},
	...
	[27] = {nTime = 0, nNum = 1,   --指引技能使用
		...
		tbStartEvent = 
		{
			{"OpenGuide", 27, "PopT", "請點擊使用武功", "HomeScreenBattle", "Skill2", {0, -40}, false, true},--使用技能
		},
		tbUnLockEvent = 
		{
			{"CloseWindow", "Guide"},     --指引技能关闭
	...
	[28] = {nTime = 1, nNum = 0,   --指引摇杆移动
		...
		tbStartEvent = 
		{
			{"OpenWindowAutoClose", "RockerGuideNpcPanel", "按住[FFFE0D]左邊的搖杆[-]不松，然後滑動手指\n向前移動！"},     --指引行走
	...
	[32] = {nTime = 1, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "gw", "竟敢到咱的地盤撒野，不想活了？", 4, 1, 4},
			{"AddAnger", 400},
		},
	},
	[33] = {nTime = 5, nNum = 1,   --指引怒气使用
		...
		tbStartEvent = 
		{
			{"OpenGuide", 33, "PopT", "點擊使用大招", "HomeScreenBattle", "Skill5", {0, -40}, false, true},--使用技能
			{"OpenWindowAutoClose", "RockerGuideNpcPanel", "點擊箭頭指引的[FFFE0D]怒氣技能[-]可施放大招！"},
		},
		tbUnLockEvent = 
		{
			{"CloseWindow", "Guide"},
	...
	[100] = {nTime = 3, nNum = 0,						--boss展示
		...
		tbStartEvent = 
		{
			{"OpenWindowAutoClose", "BossReferral", "武", "言道", "忘憂島響馬頭領"},
