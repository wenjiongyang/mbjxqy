...
tbFubenSetting.LOCK = 
{
	...
	[12] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc1", "無恥惡徒，休得無禮！", 4, 0.5, 1},
	...
	[14] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc1", "柳老前輩！", 3, 0.5, 1},
		},
		tbUnLockEvent = 
		{
	...
	[15] = {nTime = 18, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc", "是獨孤少俠嗎？", 3, 0.5, 1},
			{"NpcBubbleTalk", "npc1", "柳前輩，是我！", 3, 3, 1},
			{"NpcBubbleTalk", "npc", "看來你師傅得到的是、是五色教的暗殺名單，快、快去長安通知顧楓……", 3, 5, 1},
			{"NpcBubbleTalk", "npc1", "那您……", 3, 8, 1},
			{"NpcBubbleTalk", "npc", "我、我不行了……", 3, 10, 1},
			{"NpcBubbleTalk", "npc1", "柳伯伯，方勉真的是五色教第一把劍嗎？", 3, 12, 1},
			{"NpcBubbleTalk", "npc", "絕無可能……還有……你們兩家的恩、恩仇，其實……", 3, 15, 1},
		},
		tbUnLockEvent = 
		{
		},
