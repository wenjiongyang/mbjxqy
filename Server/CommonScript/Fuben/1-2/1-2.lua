...
tbFubenSetting.LOCK = 
{
	...
	[2] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "start_npc", "天哪！離憂山的毒蜂是不是很大啊？！", 5, 0, 1},
	...
	[5] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "start_npc", "啊呀...毒蜂要衝過來了！", 5, 0, 1},
		},
	},
	...
	[12] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
		    ...
		    {"NpcBubbleTalk", "start_npc", "呼呼...終於找到銀絲草了，太好了！", 3, 0, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[15] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "start_npc", "這個蜂王有毒，要小心哦！", 3, 0, 1},
	...
	[17] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "start_npc", "你的輕功怎麼樣？從這邊可以登上山崖。", 3, 0, 1},
	...
	[33] = {nTime = 5, nNum = 1,   --指引技能使用
		...
		tbStartEvent = 
		{
			...
			{"OpenGuide", 33, "PopT", "請點擊使用輕功", "HomeScreenBattle", "SkillDodge", {0, -40}, false, true},--使用技能
			{"OpenWindowAutoClose", "RockerGuideNpcPanel", "點擊箭頭指引的[FFFE0D]輕功[-]可進行躲避！"},
		},
		tbUnLockEvent = 
		{
	...
	[34] = {nTime = 5, nNum = 1,   --指引技能使用
		...
		{
			{"SetGameWorldScale", 0.05},
			{"OpenGuide", 34, "PopT", "請點擊使用輕功", "HomeScreenBattle", "SkillDodge", {0, -40}, false, true},--使用技能
			{"OpenWindowAutoClose", "RockerGuideNpcPanel", "點擊箭頭指引的[FFFE0D]輕功[-]可進行躲避！"},
		},
		tbUnLockEvent = 
		{
