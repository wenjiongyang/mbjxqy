...
tbFubenSetting.LOCK = 
{
	...
	[13] = {nTime = 4, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "boss", "武夷派大弟子不過如此嘛！", 4, 0.5, 1},
			{"NpcBubbleTalk", "npc", "咳咳...要殺要剮，悉聽尊便...廢話少說！", 4, 2, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[15] = {nTime = 17, nNum = 1,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "boss", "來者何人？", 3, 0, 1},
			{"NpcBubbleTalk", "npc1", "衡山獨孤劍！", 3, 2, 1},
			{"NpcBubbleTalk", "boss", "怎麼？那個劉輕舟不是死了嗎？衡山派還在？", 3, 4, 1},
			{"NpcBubbleTalk", "npc1", "（大怒）是你們害我師傅？！今日...又來武夷派，有何陰謀？", 3, 7, 1},
			{"NpcBubbleTalk", "boss", "哈哈哈！乳臭未乾的小子懂什麼？現在離開還來得及！", 3, 10, 1},
			{"NpcBubbleTalk", "npc2", "獨孤大哥，此人看來是不會說實話了，先救下張兄再說！", 3, 13, 1},
