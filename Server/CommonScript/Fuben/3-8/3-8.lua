...
tbFubenSetting.NPC = 
{
	[1] = {nTemplate  = 1351,		nLevel = 32, nSeries = -1},  --狐狸
	[2] = {nTemplate  = 1352,		nLevel = 32, nSeries = -1},  --狐狸精英
	[3] = {nTemplate  = 1353,		nLevel = 34, nSeries = -1},  --狐狸王

	[4] = {nTemplate  = 684,		nLevel = 34, nSeries = 0},  --杨影枫
	[5] = {nTemplate  = 1354,		nLevel = 34, nSeries = 0},  --孟知秋

	[8] = {nTemplate = 74,			nLevel = 32, nSeries = 0},  --上升气流
	[9] = {nTemplate  = 104,		nLevel = 32, nSeries = 0},  --动态障碍墙
}
...
tbFubenSetting.LOCK = 
{
	...
	[12] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc", "（大喊）晚輩楊影楓拜見孟穀主！", 4, 0.5, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[14] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc1", "不必多禮。", 4, 0.5, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[21] = {nTime = 4, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc", "孟谷主不愧是武林盟主，晚輩輸得口服心服！", 4, 0, 1},
		},
		tbUnLockEvent = 
		{
