...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 0, nNum = 11,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw1", "又有肥羊來了，兄弟們上啊！", 4, 1, 1},
			{"NpcBubbleTalk", "gw2", "嘿嘿，要從此路過留下買路財！", 4, 2.5, 1},
			{"NpcBubbleTalk", "gw3", "沒想到這廝還有些本事！", 4, 3.5, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[6] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"RaiseEvent", "PartnerSay", "好險的斷崖！！！", 3, 1},
		},
	},
	[7] = {nTime = 0, nNum = 1,
		tbPrelock = {6},
	...
	[8] = {nTime = 0, nNum = 10,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw1", "兄弟們，有人來壞我們的好事了！", 4, 1, 1},
			{"NpcBubbleTalk", "gw2", "嘿嘿，找死！", 4, 2.5, 1},
			{"NpcBubbleTalk", "gw2", "哪來的無名之輩！", 4, 3.5, 1},

			{"AddNpc", 7, 1, 0, "wall", "wall1", false, 16, 0, 0, 0},
		},
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "npc", "這些傢伙在幹些什麼勾當？", 4, 2, 1},
	...
	[13] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc1", "多謝兩位大俠相救！", 4, 0, 1},
		},
		tbUnLockEvent = 
		{
			{"GameWin"},		
...
---------------------------剧情镜头----------------
	...
	[16] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc", "哈哈哈，這麼熱鬧，讓在下也來插一腳怎麼樣？", 5, 0, 1},
		},
		tbUnLockEvent = 
		{
		},
...
---------------------------持续陷阱-----------------
	...
	[19] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "sl", "想不到還有幾分實力，再試試！", 4, 0, 1},
		},
	},
	...
	[100] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "npc", "前方似乎有些情況！", 4, 1, 1},
			{"BlackMsg", "繼續前行"},
		},
	},
	[101] = {nTime = 0, nNum = 1,
