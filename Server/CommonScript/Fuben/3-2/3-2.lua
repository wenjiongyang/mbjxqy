...
tbFubenSetting.LOCK = 
{
	...
	[100] = {nTime = 4, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "cm", "大俠救命！", 4, 0.5, 1},
			{"NpcBubbleTalk", "cm1", "救命啊！綁架啦！", 4, 0.5, 1},
		},
		tbUnLockEvent = 
		{
			{"ChangeFightState", 1},
			...
			{"NpcBubbleTalk", "gw1", "敢壞我們的好事，活得不耐煩了！", 4, 2, 1},
			{"BlackMsg", "擊敗在此處綁架村民的蒙面人！"},
	...
	[4] = {nTime = 0, nNum = 8,
		...
		tbUnLockEvent = 
		{
			{"RaiseEvent", "PartnerSay", "真是膽大包天，光天化日之下也敢綁架？！！", 3, 1},
			{"NpcBubbleTalk", "cm", "謝謝大俠救了我們！", 4, 0, 2},
			{"NpcBubbleTalk", "cm1", "奴家...多謝大俠！", 4, 0, 1},
			{"BlackMsg", "繼續前進查探情況！"},
	...
	[101] = {nTime = 4, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"BlackMsg", "擊敗在此處綁架村民的蒙面人！"},
			{"NpcBubbleTalk", "gw1", "來者何人？你最好別管閒事！", 4, 2, 1},
	...
	[6] = {nTime = 0, nNum = 10,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "cm", "謝謝大俠救了我們！", 4, 0, 3},
			{"NpcBubbleTalk", "cm1", "奴家...多謝大俠！", 4, 0, 2},
			{"NpcBubbleTalk", "npc", "繼續前進查探情況！", 3, 1, 1},
	...
	[9] = {nTime = 4, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "sl", "就這麼帶這個小妞兒回去交差是不是太可惜了？我們兄弟冒了多大的危險才把她抓來，不如......", 3, 0.5, 1},
			{"NpcBubbleTalk", "gw1", "嘿嘿……大哥說的對，我也想嘗一嘗這武林盟主的女兒到底是什麼滋味。", 3, 3.5, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[103] = {nTime = 6, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "sl", "你是誰？竟敢管我們的閒事，活的不耐煩了？", 3, 0, 1},
			{"NpcBubbleTalk", "npc", "無恥之徒，竟胡亂綁架無辜之人...", 3, 2, 1},
			{"NpcBubbleTalk", "gw1", "大哥，別跟這小子廢話，宰了他！", 3, 4, 1},
		},
		tbUnLockEvent = 
		{
			{"BlackMsg", "救下木箱中的人！"},
	...
	[10] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"SetAiActive", "gw", 1},
			{"SetAiActive", "gw1", 1},
			{"NpcBubbleTalk", "sl", "壞老子的好事，找死！", 3, 1, 1},
			{"NpcBubbleTalk", "npc", "多行不義必自斃！", 3, 2, 1},
			{"AddNpc", 1, 5, 0, "gw", "guaiwu6", false, 0, 4, 9005, 0.5},
			{"AddNpc", 2, 2, 0, "gw1", "guaiwu6_1", false, 0, 4, 9005, 0.5},
			{"NpcBubbleTalk", "gw1", "大家一齊上，別讓這小子跑了。", 4, 4, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[12] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"SetForbiddenOperation", true},
			{"SetAllUiVisiable", false},
			{"NpcBubbleTalk", "npc", "讓我看看這箱子裡裝的是誰！", 3, 0, 1},
		},
		tbUnLockEvent = 
		{
		},
