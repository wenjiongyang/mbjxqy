...
tbFubenSetting.LOCK = 
{
	...
	[14] = {nTime = 0, nNum = 2,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc3", "多謝大俠相助！", 4, 0, 1},
			{"NpcBubbleTalk", "npc4", "後會有期！", 4, 0, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[15] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "boss", "你們是何人？膽敢私放囚犯？", 4, 0.5, 1},
		},
		tbUnLockEvent = 
		{
			{"DoDeath", "gw"},
	...
	[17] = {nTime = 12, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc2", "馮...馮麻子，你...你怎麼來了？", 3, 1, 1},
			{"NpcBubbleTalk", "boss", "姚公子？你帶人放了囚犯，如何向知府交代啊？", 3, 3, 1},
			{"NpcBubbleTalk", "npc2", "我...我自會...向我爹交...交代，你...你管不著！", 3, 5, 1},
			{"NpcBubbleTalk", "npc", "人是我讓他放的，如何？", 3, 7, 1},
			{"NpcBubbleTalk", "boss", "嘿嘿，哪來的臭小子，找死！姚公子你最好站遠點！", 3, 9, 1},
			{"NpcBubbleTalk", "npc2", "好！你...你們動手，我...我看戲。", 3, 11, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[18] = {nTime = 1.5, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"BlackMsg", "擊敗忽然出現的牢頭！"},
			{"NpcBubbleTalk", "boss", "兄弟們出來！一起上！", 3, 2.5, 1},
