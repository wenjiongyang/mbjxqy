...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw1", "居然自己闖入摘星地牢，你是不是瘋了？", 4, 2.5, 1},
			{"BlackMsg", "擊敗守衛地牢的無憂弟子。"},
			{"RaiseEvent", "PartnerSay", "你們把納蘭姑娘關在哪裡了？", 3, 1},
		},
		tbUnLockEvent = 
		{
	...
	[5] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			{"RaiseEvent", "PartnerSay", "此處戒備森嚴，必然關押著重要的人！", 3, 1},
			{"TrapUnlock", "trap2", 5},
	...
	[6] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw1", "不知死活的傢伙，自己送上門來了！", 4, 2.5, 2},
		},
		tbUnLockEvent = 
		{
	...
	[8] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "sl", "膽敢劫獄？吃我一槍！", 4, 1.5, 1},
			{"NpcBubbleTalk", "gw1", "兄弟們上啊！", 4, 3, 1},
			{"RaiseEvent", "PartnerSay", "好像有大傢伙出現了！", 3, 2},
			{"BlackMsg", "擊敗守衛此處的牢頭"},
		},
		tbUnLockEvent = 
		{
