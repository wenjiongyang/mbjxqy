...
tbFubenSetting.LOCK = 
{
	...
	[15] = {nTime = 3, nNum = 0,
		...
		tbStartEvent = 
		{
			{"OpenWindowAutoClose", "BossReferral", "烈", "焰骷髏", "離憂山洞霸主"},
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "BOSS", "這裡就是你的葬身之地！", 3, 0.5, 1},
			{"NpcBubbleTalk", "Start_Npc1", "楊大哥，這個傢伙...長得好醜啊！", 3, 2.5, 1},
			{"NpcBubbleTalk", "Start_Npc2", "沒事，外強中乾而已！", 3, 3.5, 1},
		},
	},
	[16] = {nTime = 0, nNum = 1,
		tbPrelock = {15},
	...
	[20] = {nTime = 1, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "Start_Npc1", "這裡什麼都沒有的樣子，好無聊！", 3, 0, 1},
			{"NpcBubbleTalk", "Start_Npc2", "真兒，你在找什麼呀？", 3, 1, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[22] = {nTime = 1, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "Start_Npc1", "這也空無一物！", 3, 0, 1},
	...
	[24] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "Start_Npc1", "咦？這是什麼？", 3, 0, 1},
	...
	[25] = {nTime = 1, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "Start_Npc2", "真兒！！", 3, 0.5, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[30] = {nTime = 5, nNum = 1,   --指引打坐使用
		...
		tbStartEvent = 
		{
			{"RaiseEvent", "PartnerSay", "你受傷了！趕緊[FFFE0D]打坐療傷[-]！！", 4, 1},
			{"RaiseEvent", "ChangeAutoFight", false},
			{"OpenGuide", 30, "PopT", "請點擊使用打坐", "HomeScreenBattle", "BtnDazuo", {0, -40}, true, true},--使用技能
			{"OpenWindowAutoClose", "RockerGuideNpcPanel", "點擊箭頭指引的[FFFE0D]打坐技能[-]可進行生命恢復！"},
		},
		tbUnLockEvent = 
		{
			{"AddAnger", -300}, 
...
-------------------------------变身玩法---------------
	...
	[34] = {nTime = 7, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "Start_Npc1", "啊，這個是...我小時候玩的玄天武機？", 3, 0, 1},
			{"NpcBubbleTalk", "Start_Npc1", "沒想到還能找到它！", 3, 2, 1},
			{"NpcBubbleTalk", "Start_Npc2", "好大啊！", 3, 4, 1},
			{"NpcBubbleTalk", "Start_Npc1", "少俠，你進去試試吧！", 3, 6, 1},
		},
		tbUnLockEvent = 
		{	
		},
	...
	[36] = {nTime = 4, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "Start_Npc2", "好像有什麼聲音？", 3, 2.5, 1},
		},
		tbUnLockEvent = 
		{	
		},
	...
	[100] = {nTime = 1, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "Start_Npc1", "你們快點來呀！", 3, 0, 1},
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "Start_Npc2", "真兒等等我！", 3, 0, 1},
		},
	},
