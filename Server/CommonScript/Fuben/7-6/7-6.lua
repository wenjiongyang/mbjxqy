...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw", "此路是我開，留下買路財!", 3, 1, 1},

			{"RaiseEvent", "PartnerSay", "鼠輩！", 3, 1},
			{"BlackMsg", "擊敗此處的江湖宵小！"},
	...
	[7] = {nTime = 0, nNum = 12,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw", "站住，要錢還是要命！", 3, 1, 2},
			{"RaiseEvent", "PartnerSay", "沒完沒了！", 3, 1},
	...
	[15] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"SetAiActive", "sl", 1},
			{"BlackMsg", "保護張如夢不被南宮彩虹擊殺！"},

			{"NpcBubbleTalk", "npc", "彩虹，動手吧！", 3, 0, 1},
	...
	[16] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "sl", "你怎麼不還手？想死麼？", 3, 0, 1},
			{"NpcBubbleTalk", "npc", "你別管我！", 3, 1, 1},
		},
	},
	[17] = {nTime = 0, nNum = 1,
		tbPrelock = {16},
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "sl", "我動真格的了，你當真不還手？", 3, 0, 1},
	...
	[18] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "sl", "氣死我了，你到底要怎樣？", 3, 0, 1},
			{"NpcBubbleTalk", "npc", "彩虹，我們停手吧！", 3, 1.5, 1},
