...
tbFubenSetting.LOCK = 
{
	...
	[4] = {nTime = 0, nNum = 8,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw", "想救岳飛，沒那麼容易！!", 3, 1, 1},

			{"RaiseEvent", "PartnerSay", "方勉果然投敵了！", 3, 1},
			{"BlackMsg", "擊敗攔路的敵人！"},
	...
	[7] = {nTime = 0, nNum = 12,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "gw", "殺啊！殺了這些宋人！", 3, 1, 2},
	...
	[19] = {nTime = 8, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc", "（咬牙）我要殺了你！殺了你……", 5, 1, 1},
			{"NpcBubbleTalk", "npc1", "（難過）獨孤大哥！他已經死了……", 3, 4, 1},
	...
	[20] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc", "（流淚）琳...兒...", 3, 1, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[23] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			{"OpenWindow", "StoryBlackBg", "獨孤劍和楊瑛二人面對斷崖，一直站著...", "", 1, 2, 1},
	...
	[24] = {nTime = 6, nNum = 0,
		...
		tbStartEvent = 
		{
			{"OpenWindow", "StoryBlackBg", "兩人默默告別。鳳凰頂上，楊瑛黯然注視著那個單薄的背影，寂寞遠去……不知是對，是錯……", "", 2, 2, 1},
		},
		tbUnLockEvent = 
		{
			{"GameWin"},
