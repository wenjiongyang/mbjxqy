...
tbFubenSetting.LOCK = 
{
	...
	[14] = {nTime = 8, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc1", "我們就在這裡躲起來。", 3, 0, 1},
			{"NpcBubbleTalk", "npc", "那個黃劍堂堂主會上鉤嗎？", 3, 2, 1},
			{"NpcBubbleTalk", "npc1", "你放心吧，他一定會來！", 3, 4, 1},
			{"NpcBubbleTalk", "npc1", "他來了！", 3, 6, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[20] = {nTime = 0, nNum = 2,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "npc", "原來黃劍堂堂主竟然是你！", 4, 0, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[21] = {nTime = 12, nNum = 0,
		...
		{
			{"SetNpcDir", "boss", 40},
			{"NpcBubbleTalk", "boss", "原來你們……", 4, 0, 1},
			{"NpcBubbleTalk", "npc1", "我們當然沒走，不這樣，怎麼能引你出來呢？", 4, 2, 1},
			{"NpcBubbleTalk", "npc", "無相！放下屠刀，立地成佛。你這是何苦？", 4, 4, 1},
			{"NpcBubbleTalk", "boss", "哼！區區一個戒律院首座，我可不甘心。時至今日，有死而已，你們上吧。", 4, 7, 1},
			{"NpcBubbleTalk", "npc1", "哼！你這樣的少林叛徒，看招！", 4, 10, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[24] = {nTime = 2.5, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "boss", "黃毛小兒，竟敢戲弄於我！我一定不會放過你的！", 4, 0, 1},
		},
		tbUnLockEvent = 
		{
...
----------------------------动画添加------------
	...
	[29] = {nTime = 1, nNum = 0,
		...
		tbStartEvent = 
		{
			{"OpenWindow", "BossReferral", "無", "相", "戒律院首座"},
		},
		tbUnLockEvent = 
		{
