...
DefendFuben.tbSeriesSetting = 
{
	["Dialog"] = {
		...
		[2] = {FontSize = 18, NotShow = 0, XPos = 0, YPos = 0, Color = "FiveElement2", Index = "Series_Mu1",   Text = "逍遙"},
		...
		[5] = {FontSize = 18, NotShow = 0, XPos = 0, YPos = 0, Color = "FiveElement5", Index = "Series_Tu1",   Text = "武當"},
	},
	["Monster"] = {
