...
tbFubenSetting.LOCK = 
{
	...
	[11] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "npc1", "無恥鼠輩，大言不慚！", 4, 2, 1},
			{"BlackMsg", "擊敗五色教頭目！"},
			{"SetAllUiVisiable", true}, 
			{"SetForbiddenOperation", false},
	...
	[30] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Patrol_1", "你是什麼人，竟敢擅闖方員外山莊！", 4, 0, 1},
	...
	[31] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Patrol_2", "你是什麼人，竟敢擅闖方員外山莊！", 4, 0, 1},
	...
	[32] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Patrol_3", "你是什麼人，竟敢擅闖方員外山莊！", 4, 0, 1},
	...
	[33] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Patrol_4", "你是什麼人，竟敢擅闖方員外山莊！", 4, 0, 1},
