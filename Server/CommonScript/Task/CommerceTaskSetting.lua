CommerceTask.tbCommerceNpc = { nNpcTemplateId = 190, nMapTemplateId = 10 };
...
CommerceTask.ALL_COMPLETE_AWARD_B60 = {"Item", 787, 2}--全部完成的奖励道具ID，小于60级
CommerceTask.ALL_COMPLETE_AWARD_A60 = {"Item", 3013, 1}--全部完成的奖励道具ID，大于等于60级
...
CommerceTask.szNotAllCompleteMsg = "您還有尚未裝滿的箱子，確定要完成任務嗎？（裝滿所有箱子可以獲得更多的獎勵）"
