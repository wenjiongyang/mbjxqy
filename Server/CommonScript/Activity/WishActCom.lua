...
tbAct.tbErrMsg = {
    [tbAct.nErrCode_NoLikeTimes]    = "點贊次數已用完",
    [tbAct.nErrCode_NoKin]          = "請先加入一個幫派",
    [tbAct.nErrCode_NoWish]         = "沒找到對應願望，請重新嘗試",
    [tbAct.nErrCode_RepeatLike]     = "每條願望只能點贊一次",
    [tbAct.nErrCode_ContentTooL]    = "願望最多不能超過三十個字元",
    [tbAct.nErrCode_LimitWords]     = "你許下的願望含有敏感字元，請修改後重試",
    [tbAct.nErrCode_NoWishTime]     = "每個角色只能進行一次許願",
    [tbAct.nErrCode_NoInTime]       = "結束了",
    [tbAct.nErrCode_LackGold]       = "元寶不足",
}
