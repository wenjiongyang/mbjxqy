...
function tbItem:CheckCanUse(it)
    ...
    return nHadUse < tbInfo.nUseMaxNum, string.format("不能夠使用超過%d次", tbInfo.nUseMaxNum)
end
...
function tbItem:GetIntrol(dwTemplateId)
    ...
    return string.format("%s\n使用數量：%d/%d", tbInfo.szIntro, nCount, tbLimitInfo.nUseMaxNum)
end