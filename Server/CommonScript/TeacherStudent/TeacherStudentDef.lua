TeacherStudent.Def = {
	...
	szTeacherNoticeDefault = "漫漫江湖路，我想找一個徒弟！",	--默认收徒公告
	nForceDissmissTime = 7*24*3600,	--离线超过x秒，可以强制解除关系
	nForceGraduateTime = 7*24*3600,	--离线超过x秒，可以强制出师
	...
	nAddStudentInterval = 7*24*3600,	--收徒时间间隔

	nGraduateConnectDaysMin = 14,	--出师：拜师时间最少天数
	...
	nDailyChuanGongMax = 4,	--每日最多累计传功次数(2徒弟，2师父)
