...
Fuben:SetFubenSetting(Fuben.DungeonFubenMgr.nMapTemplateIdMine, tbFubenSetting)		-- 绑定副本内容和地图

tbFubenSetting.nDuraTime 				=  300; -- 副本时长
tbFubenSetting.szFubenClass 			= "DungeonFubenFloor2";									-- 副本类型
tbFubenSetting.szName 					= "魂石秘藏"											-- 单纯的名字，后台输出或统计使用
tbFubenSetting.szNpcPointFile 			= "Setting/Fuben/DungeonFuben/2_2/NpcPos.tab"			-- NPC点
--tbFubenSetting.szPathFile = "Setting/Fuben/TestFuben/NpcPos.tab"								-- 寻路点
tbFubenSetting.tbBeginPoint 			= {3243, 6447}											-- 副本出生点
tbFubenSetting.nNpcRegionPart			= 5; --刷出的魂石在5个区域内随机
tbFubenSetting.szRegionPrefix			= "Mine"; --刷出的魂石点集前缀
tbFubenSetting.tbGuohuoPoint 			= {3440, 6479};
...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			{"RaiseEvent", "OwnerShowTaskDialog", 4004, true},	--对创建者的剧情对话 
