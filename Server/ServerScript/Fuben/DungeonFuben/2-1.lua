...
Fuben:SetFubenSetting(Fuben.DungeonFubenMgr.nMapTemplateIdBoss, tbFubenSetting)		-- 绑定副本内容和地图

tbFubenSetting.nDuraTime 				=  300; -- 副本时长
tbFubenSetting.szFubenClass 			= "DungeonFubenFloor2";									-- 副本类型
tbFubenSetting.szName 					= "妖獸巢穴"											-- 单纯的名字，后台输出或统计使用
tbFubenSetting.szNpcPointFile 			= "Setting/Fuben/DungeonFuben/2_1/NpcPos.tab"			-- NPC点
--tbFubenSetting.szPathFile = "Setting/Fuben/TestFuben/NpcPos.tab"								-- 寻路点
tbFubenSetting.tbBeginPoint 			= {2338, 6000}											-- 副本出生点
tbFubenSetting.tbBossPoint 				= {2404, 6759}											--刷出的boss位置
tbFubenSetting.tbTempRevivePoint 		= {2338, 6000}											-- 临时复活点，副本内有效，出副本则移除
...
tbFubenSetting.NPC = 
{
	[1] = {nTemplate = 695, nLevel = 1, nSeries = 0}, --篝火
...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			{"RaiseEvent", "OwnerShowTaskDialog", 4003, true},	--对创建者的剧情对话 
			...
			{"AddNpc", 2, 1, 1, "wall1", "wall_1_1",false, 43},
		},
	},
	...
	[2] = {nTime = 3, nNum = 0, 
		...
		tbStartEvent = 
		{
			{"BlackMsg", "妖獸首領即將出現，請做好準備!"},
		},
		tbUnLockEvent = 
		{
			{"BlackMsg", "妖獸首領出現了!"},
			{"RaiseEvent", "CreateBoss"},
		},
	},
	[3] = {nTime = 0, nNum = 1, --代码中控制杀死boss解锁了
		tbPrelock = {2},
		tbStartEvent = 
		{
			...
			tbUnLockEvent = 
		{
			{"BlackMsg", "恭喜您成功擊殺妖獸首領"},
			{"AddNpc", 1, 1, 0, "Gouhuo", "Gouhuo"},
		},
	},
	[4] = {nTime = 60, nNum = 0, 
		tbPrelock = {3},
	...
	[5] = {nTime = tbFubenSetting.nDuraTime, nNum = 0,
		tbPrelock = {1},
		tbStartEvent = 
		{
		},
